...
class Trace {
     ...
     * @return void
     */
    public static function importTrace(array $trace=[]){
        self::$trace = array_merge(self::$trace,$trace);
    }
     ...
     * @return void
     */
    public static function importStatus(array $status=[]){
        self::$status = array_merge(self::$status,$status);
    }
