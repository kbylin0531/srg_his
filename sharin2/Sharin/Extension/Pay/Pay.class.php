...
abstract class Pay {
    ...
    protected function _buildForm($params, $gateway, $method = 'post', $charset = 'utf-8') {
        ...
        $sHtml = "$sHtml</form>Loading......<script>document.forms['paysubmit'].submit();</script>";
        return $sHtml;
    }
    ...
    final protected function fsockOpen($url, $limit = 0, $post = null, $cookie = '', $bysocket = FALSE, $ip = '', $timeout = 15, $block = TRUE, $encodetype = 'URLENCODE', $allowcurl = TRUE, $position = 0, $files = array()) {
        $return = '';
        ...
        $boundary = $encodetype == 'URLENCODE' ? '' : rand(40);//random(40)
