...
namespace System\Extension\Pay\Driver;
use System\Exception\CoraxException;
use System\Extension\Pay\Pay;
use System\Extension\Pay\PayVo;
...
class Aliwappay extends Pay {
    ...
    public function buildRequestForm(PayVo $vo) {
        ...
        if (isset($return_data['res_error'])) {
            ...
            throw new CoraxException('[(' . $doc->getElementsByTagName('code')->item(0)->nodeValue . ')' . $doc->getElementsByTagName('msg')->item(0)->nodeValue . ']' . $doc->getElementsByTagName('detail')->item(0)->nodeValue);
        }
        //获取request_token
