...
$GLOBALS['lite_admin_theme'] = empty($GLOBALS['lite_admin_theme'])?'Sheep':$GLOBALS['lite_admin_theme'];

//password to gain access
$password = 'sharingan';

//directory relative to this file to search for databases (if false, manually list databases in the $databases variable)
$directory = empty($GLOBALS['lite_admin_database'])?'.':$GLOBALS['lite_admin_database'];
...
$databases = array(
	array(
        'path'=> '/home/asus/Web/shalite/App/Pube/Library/Utils/sqlite3.db',
		'name'=> 'Database 1'
	),
);
