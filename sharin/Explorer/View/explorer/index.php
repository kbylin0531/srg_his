...
<link href="./static/style/skin/<?php echo $config['user']['theme'];?>app_explorer.css" rel="stylesheet" id='link_css_list'/>
...
<script src="./<?php echo ENTRY_FILE; ?>?user/common_js&type=explorer&id=<?php echo rand_string(8);?>"></script>
