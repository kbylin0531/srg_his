...
define("app/src/edit/main", ["lib/jquery-lib", "lib/util", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "./function_list", "./taskTap", "./toolbar", "./edit", "./mode", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html"], function (e) {
    ...
    var e = {
        php: [{
            ...
            reg_index: 1,
            type: "function"
        }, {reg: /\s*class\s+(\w*)\s*.*\{/g, reg_name: /\s*class\s+(\w*)\s*.*\{/, reg_index: 1, type: "class"}],
        javascript: [{
        ...
        python: [{
            ...
            reg_index: 1,
            type: "class"
        }, {reg: /\s*def\s+(\w+)\s*\(.*\)/g, reg_name: /\s*def\s+(\w+)\s*\(.*\)/, reg_index: 1, type: "function"}],
        ruby: [{
            reg: /\s*class\s+(\w+)\s*/g,
            reg_name: /\s*class\s+(\w+)\s*/,
            reg_index: 1,
        ...
        if (a) {
            for (var i = [], n = a.length, s = 0, o = e, r = 0; n > r; r++) {
                ...
                if (!(2 > c.length) && c[t.reg_index]) {
                    ...
                    var d = o.indexOf(l.the_match), p = l.the_match.indexOf(l.name);
        ...
        var e = '<div class="cell_null">No outline for the active view</div>', t = Editor.current();
        if (!t || t.kod === void 0)return $(".function_list_box").html(e), void 0;
        var n = function (e) {
            var t = e.replace(/(^\s*)|(\s*$)/g, "");
            return t.replace(/(\{$)/, "")
        }, s = t.kod.mode, o = a(t.getValue(), s);
        ...
        for (var l = 0; o.length > l; l++) {
            ...
            if (d) {
                ...
                var p = d.start.row + "," + d.start.column + "," + d.end.row + "," + d.end.column, u = n(n(c.the_match)).substr(0, 150);
        ...
        $(".function_list_box .list_row").die("mouseenter").live("mouseenter", function () {
            ...
            var e = $(this).attr("data-range"), t = e.split(","), a = {
                start: {row: t[0], column: t[1]},
                end: {row: t[2], column: t[3]}
            };
            Editor.current() && (Editor.current().gotoLine(t[0]), Editor.current().selection.setSelectionRange(a, !0))
        })
    };
    return {
        init: s, refresh: n, mode_list: function () {
            return objectKeys(e)
        }
    }
    ...
    var e = function () {
        ...
        var e, t, a, i, n = !1, s = !1, o = 0, r = 0, l = 0, c = 0, d = 0, p = 0;
        ...
        var u = function (i) {
            ...
            var n = e.get(0).getBoundingClientRect().top - $sizeInt(e.css("margin-top")), u = i.clientX - o + r;
            ...
            if (!e.is(":animated") || i != a) {
                ...
                var s = e.width(), o = $(".edit_tab .tab_" + a), r = e.clone(!0).insertAfter(e).css({
                    "margin-right": "0px",
                    border: "none"
                }).addClass("insertTemp");
                "left" == n ? e.after(o).css("width", "0px") : (e.before(o).css("width", "0px"), o.before(r)), e.animate({width: s + "px"}, animate_time), r.animate({width: "0px"}, animate_time, function () {
                    $(this).remove(), t = $(".edit_tab .tab")
                })
            }
        }, m = function () {
            n = !1, s = !1, startTime = 0, $(".dragMaskView").remove(), void 0 != a && (r = e.get(0).getBoundingClientRect().left, a.animate({left: r + "px"}, animate_time, function () {
                e.css("opacity", 1), $(this).remove()
            }))
        }
    }, n = function (e, t, a) {
        var i = 1.5 * animate_time, n = 122, s = n, o = $(".edit_tab .tab"), r = $sizeInt($(".edit_tab .tabs").width()) - 4, l = $sizeInt(o.css("margin-right")) + $sizeInt(o.css("border-right")), c = $sizeInt($(".edit_tab .add").css("width")) + 2 * l, d = o.length, p = Math.floor((r - c) / (n + l));
        switch (d > p && (s = Math.floor((r - c) / d) - l), e) {
            case"add":
                $(".edit_tab .tabs .this").css({
                    "margin-top": "30px",
                    width: s
                }).animate({"margin-top": "0px"}, i), o.animate({width: s + "px"}, i);
                break;
            case"remove":
                void 0 != a && Editor.select(a), t.animate({width: "0", "margin-top": "+=30"}, i, function () {
                    t.remove()
                }), o.animate({width: s + "px"}, i);
                break;
            case"resize":
                o.css("width", s + "px");
                break;
    ...
    return {
        rightMenu: {hidden: t}, resetWidth: n, init: function () {
    ...
    var e = function () {
        $(window).bind("resize", function () {
            ...
            callback: t,
            items: {
                save: {name: LNG.button_save + "<b>Ctrl+S</b>", icon: "save", accesskey: "s"},
                saveall: {name: LNG.button_save_all, icon: "paste", accesskey: "a"},
                sep1: "---------",
                refresh: {name: LNG.refresh + "<b>F5</b>", className: "refresh", icon: "refresh", accesskey: "e"},
                newfile: {name: LNG.newfile, icon: "file-alt", accesskey: "j"},
                sep2: "---------",
                close: {name: LNG.close, icon: "remove", accesskey: "q"}
            }
        }), $.contextMenu({
            ...
            callback: t,
            items: {
                undo: {name: LNG.undo + "<b>Ctrl+Z</b>", icon: "undo"},
                redo: {name: LNG.redo + "<b>Ctrl+Y</b>", icon: "repeat"},
                sep1: "---------",
                startAutocomplete: {name: LNG.complete_current, icon: "code"},
                search: {name: LNG.search + "<b>Ctrl+F</b>", icon: "search"},
                searchReplace: {name: LNG.replace + "<b>Ctrl+F+F</b>", icon: "exchange"},
                gotoline: {name: LNG.gotoline + "<b>Ctrl+L</b>", icon: "pushpin"},
                sep2: "---------",
                selectAll: {name: LNG.selectAll + "<b>Ctrl+A</b>", icon: "eye-open"}
            }
        });
        for (var e = [12, 13, 14, 15, 16, 18, 20, 24, 28, 32], a = G.code_theme_all.split(","), i = Editor.mode.modeAll(), s = {}, o = {}, r = {}, l = 0; e.length > l; l++) {
            var c = e[l];
            s["set_code_font-" + c] = {name: c + "px", className: "set_code_font-" + c}
        }
        for (var l = 0; a.length > l; l++) {
            var d = a[l];
            o["set_code_theme-" + d] = {name: d, className: "set_code_theme-" + d}
        }
        for (var l = 0; i.length > l; l++) {
            var p = i[l];
            r["set_code_mode-" + p] = {name: p, className: "set_code_mode-" + p}
        }
        $.contextMenu({
            ...
            callback: t,
            items: {
                code_font: {className: "code_font_list", name: LNG.font_size, icon: "font", items: s},
                code_theme: {className: "code_theme_list", name: LNG.code_theme, icon: "magic", items: o},
                code_mode: {className: "code_mode_list", name: LNG.code_mode, icon: "leaf", items: r},
                sep1: "---------",
                function_list: {name: LNG.function_list + "<b>Ctrl+R</b>", className: "function_list"},
                auto_complete: {name: LNG.auto_complete, className: "auto_complete"},
                sep2: "---------",
                wordbreak: {name: LNG.wordwrap, className: "wordbreak"},
                display_char: {name: LNG.char_all_display, className: "display_char"},
                sep3: "---------",
                fullscreen: {name: LNG.full_screen, icon: "fullscreen"}
            }
        }), $.contextMenu({
            ...
            items: {
                ...
                open_ie: {name: LNG.open_ie, icon: "globe", accesskey: "b"}
            }
        }), $.contextMenu({
            ...
            callback: t,
            items: {
                setting: {name: LNG.setting, icon: "cog"},
                about: {name: LNG.about, icon: "info-sign"},
                sep1: "---------",
                learnMore: {name: LNG.learnMore, icon: "question"}
            }
        ...
        }), $(".tools a[action]").tooltip({placement: "bottom"})
    }, t = function (e) {
        switch (e) {
            case"newfile":
                Editor.add();
        ...
        var i = function (i) {
            ...
            if (!e)return !0;
            var n = i.pageX - t, s = a - n, o = $(window).width();
        ...
        var e = $(".frame_right"), t = $(".frame_left"), a = e.find("input"), i = function (t, i) {
            var s = 0;
            if ("function_list" == t) {
        ...
        return {
            open: i, openUrl: function () {
                ...
                e.stop(!0, !0).animate({width: 0}, 200, function () {
    ...
    return {
        preview: n, doAction: t, toolbarSelected: a, init: function () {
    ...
    var s = function (e, t) {
        ...
        for (var i in a)if (a[i].kod[e] == t)return a[i].kod.uuid;
        return ""
    }, o = function () {
        ...
        var s = "./vis.go?editor/fileGet&filename=" + e;
        G.share_page !== void 0 && (s = "./vis.go?share/fileGet&user=" + G.user + "&sid=" + G.sid + "&filename=" + e), t = {
            charset: "utf-8",
            uuid: i,
        ...
        var o = art.dialog({title: !1, content: LNG.getting, icon: "warning"});
        $.ajax({
            dataType: "json", url: s, error: function (e, a, i) {
                o.close(), _(t.uuid), core.ajaxError(e, a, i)
            }, success: function (e) {
                if (o.close(), !e.code)return Tips.tips(e), _(t.uuid), void 0;
                var n = e.data;
                a[i] = void 0, $("pre#" + i).text(n.content), c(t), $(".edit_body .this").removeClass("this"), $(".edit_body pre#" + i).addClass("this");
                var s = a[i];
                s.kod.charset = n.charset, s.navigateTo(0), s.moveCursorTo(0, 0)
            }
        })
    }, l = function (e, t) {
        ...
        i.setTheme("ace/theme/" + t.theme), void 0 != e.mode && i.getSession().setMode("ace/mode/" + e.mode), i.getSession().setTabSize(4), i.getSession().setUseSoftTabs(!0), i.getSession().setUseWrapMode(t.wrap), i.$blockScrolling = 1 / 0, i.setShowPrintMargin(!1), i.setDragDelay(100), i.setShowInvisibles(t.display), i.setFontSize(t.fontsize), i.setAnimatedScroll(!0), i.setOptions({
            ...
            name: "editFunction",
            bindKey: {win: "Ctrl-R", mac: "Command-R", sender: "editor|cli"},
            exec: function () {
            ...
            name: "refresh", bindKey: {win: "F5", mac: "F5"}, exec: function () {
        ...
        if ($(".edit_tab .this").removeClass("this"), $(".edit_tab .tab_" + e).addClass("this"), i = e, void 0 != a[e] && a[e].focus(), t && $(".edit_tab .this").stop(!0, !0).animate({opacity: .3}, 100).animate({opacity: .8}, 100).animate({opacity: .5}, 40).animate({opacity: 1}, 40, function () {
                a[e].focus()
            }), auto_function_list) {
        ...
        if (Editor.current())try {
            var n = window.parent.art.dialog.list.openEditor, s = '<img draggable="false" src="' + G.static_path + 'images/file_16/edit.png"/>' + urlDecode(urlDecode(Editor.current().kod.filename));
            n && n.title(s)
        } catch (o) {
        }
    }, p = function (e, t) {
        ...
        for (var r in s) {
            ...
            switch (e) {
                case"resize":
                    ...
                    break;
                case"theme":
                    t[e] = i, l.setTheme("ace/theme/" + i), G.code_config.theme = i, o = {k: "theme", v: i};
                    break;
                case"fontsize":
                    t[e] = i, l.setFontSize(i), G.code_config.font_size = i, o = {k: "font_size", v: i};
                    break;
                case"wrap":
                ...
                case"display_char":
                    ...
                    var c = t[e] ? 1 : 0;
                    o = {k: "display_char", v: c};
                    break;
                case"setting":
                    l.commands.exec("showSettingsMenu", l);
                    break;
                case"function_list":
                    t[e] = i, G.code_config.function_list = i, o = {k: "function_list", v: i};
                    break;
                case"auto_complete":
                    t[e] = !l.$enableBasicAutocompletion, l.setOptions({enableLiveAutocompletion: t[e]}), l.$enableBasicAutocompletion = t[e], G.code_config.auto_complete = t[e];
                    var c = t[e] ? 1 : 0;
                    o = {k: "auto_complete", v: c};
                    break;
                default:
            }
        ...
        o && $.ajax({
            url: "./vis.go?editor/setConfig&k=" + o.k + "&v=" + o.v, dataType: "json", success: function () {
            }
        })
    }, h = function (e, t) {
        ...
        if (void 0 != i) {
            ...
            if (n.hasChanged) {
                ...
                y().focus();
                var s = urlEncode2(n.getValue()), o = n.kod.filename;
                if ("" == o)return tips(LNG.data_error, "warning"), void 0;
                var r = "./vis.go?editor/fileSave";
                G.share_page !== void 0 && (r = "./vis.go?share/fileSave&user=" + G.user + "&sid=" + G.sid + "&filename=" + o), $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: r,
        ...
        delete a[e];
        var t = "", i = $(".edit_tab .tab"), n = $(".edit_tab .tab_" + e), s = $(".edit_body pre#" + e);
        ...
        var e = Editor.current(), t = e.kod.the_url;
        if (e.kod.uuid, "" != t) {
            var a = art.dialog({title: !1, content: LNG.getting, icon: "warning"});
            $.ajax({
                dataType: "json", url: t, error: function (e, t, i) {
                    a.close(), core.ajaxError(e, t, i)
                }, success: function (t) {
                    if (a.close(), !t.code)return Tips.tips(t), void 0;
                    var i = e.getFirstVisibleRow();
                    e.getSession().setValue(t.data.content), h(e, !1), e.scrollToLine(i)
                }
            })
        }
    };
    ...
    return e(), {
        get: t, modes: a, modeAll: function () {
            return objectKeys(i)
        }
    }
