define("app/src/desktop/main", ["lib/jquery-lib", "lib/util", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "lib/picasa/picasa", "../../common/taskTap", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../common/rightMenu", "./fileSelect", "./ui", "../explorer/path", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer"], function (e) {
    Config = {
        ...
        $(".init_loading").fadeOut(450).addClass("pop_fadeout"), ui.init(), TaskTap.init(), core.update(), fileSelect.init(), rightMenu.initDesktop(), e.async("lib/webuploader/webuploader-min", function () {
            core.upload_init()
    ...
    var e = {}, a = "", t = 160, i = function () {
        $(".task_tab .tab").die("mouseenter").live("mouseenter", function (e) {
            ...
            var a = $(this).attr("id"), t = art.dialog.list[a], i = $("." + a);
        ...
        var e, a, i, n, s = !1, o = !1, r = 0, l = 0, c = 0, d = 0, p = 0, u = 0;
        ...
        var h = function (t) {
            ...
            var n = e.get(0).getBoundingClientRect().top - $sizeInt(e.css("margin-top")), o = t.clientX - r + l;
            ...
            if (!e.is(":animated") || n != i) {
                ...
                var o = e.width(), r = $(".task_tab #" + i), l = e.clone(!0).insertAfter(e).css({
                    "margin-right": "0px",
                    border: "none"
                }).addClass("insertTemp");
                "left" == s ? e.after(r).css("width", "0px") : (e.before(r).css("width", "0px"), r.before(l)), e.animate({width: o + "px"}, t), l.animate({width: "0px"}, t, function () {
                    $(this).remove(), a = $(".task_tab .tab")
                })
            }
        }, v = function () {
            o = !1, s = !1, startTime = 0, $(".dragMaskView").remove(), void 0 != i && (l = e.get(0).getBoundingClientRect().left, i.animate({left: l + "px"}, t, function () {
                e.css("opacity", 1), $(this).remove()
            }))
        }
    }, s = function (e) {
        var a = 110, i = a, n = a + 12, s = $(".task_tab .tab"), o = $(".task_tab .tabs").width() - 10, r = s.length, l = Math.floor(o / n);
        switch (r > l && (i = Math.floor(o / r) - 12), e) {
            case"add":
                $(".task_tab .tabs .this").css("width", "0").animate({width: i + "px"}, t);
            case"close":
                s.animate({width: i + "px"}, t);
                break;
            case"resize":
                s.css("width", i + "px");
                break;
        ...
        var i = t.replace(/<[^>]+>/g, ""), n = '<div class="tab taskBarMenu" id="' + a + '" title="' + i + '">' + t + "</div>";
        $(n).insertBefore(".task_tab .last"), s("add"), e[a] = {id: a, name: name}
    }, r = function (e) {
        $(".task_tab .this").removeClass("this"), $(".task_tab #" + e).addClass("this"), a = e
    }, l = function (a) {
        delete e[a], $(".task_tab #" + a).animate({width: 0}, t, function () {
            $(".task_tab #" + a).remove(), s("close"), 0 == $(".tabs .tab").length && "desktop" != Config.pageApp && $(".task_tab").addClass("hidden")
        })
    };
    return {
        add: o, focus: r, close: l, init: function () {
    ...
    return {
        filetype: {
            ...
            var t, i, n = require("../tpl/search.html"), s = require("../tpl/search_list.html"), o = function () {
            ...
            var n = UUID(), s = '<div id="' + n + '" class="item">' + '<div class="info"><span class="title" tytle="' + i + '">' + core.pathThis(i) + "</span>" + '<span class="size">0b</span>' + '<span class="state">' + LNG.upload_ready + "</span>" + '<a class="remove font-icon icon-remove" href="javascript:void(0)"></a>' + '<div style="clear:both"></div></div></div>';
            t.find(".item").length > 0 ? $(s).insertBefore(t.find(".item:eq(0)")) : t.append(s);
            var o, r, l, c = 0, d = $("#" + n), p = $("#" + n + " .state").text(LNG.download_ready), u = $('<div class="progress progress-striped active"><div class="progress-bar" role="progressbar" style="width: 0%;text-align:right;"></div></div>').appendTo("#" + n).find(".progress-bar");
            $("#" + n + " .remove").bind("click", function () {
                clearInterval(o), o = !1, clearTimeout(r), o = !1, $.get("./vis.go?explorer/serverDownload&type=remove&uuid=" + n), $(this).parent().parent().slideUp(function () {
                    $(this).remove(), ui.f5()
                })
            }), $.ajax({
            ...
            var i = 0, n = 0, s = "0B/s", o = function (e, a) {
                var t = e.size * a, i = 5;
                ...
                var n = e.speed[e.speed.length - 1], o = e.speed[0], r = (n[1] - o[1]) / ((n[0] - o[0]) / 1e3);
            ...
            uploader.on("uploadBeforeSend", function (e, a) {
                ...
                var t = o(e, a), r = $("#" + e.id), l = r.find(".progress .progress-bar");
    ...
    var fileMenuSelector = ".menufile", folderMenuSelector = ".menufolder", selectMoreSelector = ".menuMore", selectTreeSelectorRoot = ".menuTreeRoot", selectTreeSelectorFolder = ".menuTreeFolder", selectTreeSelectorFile = ".menuTreeFile", common_menu = {
        newfileOther: {
            name: LNG.newfile,
            icon: "expand-alt",
            accesskey: "w",
            ...
            items: {
                ...
                app_create: {name: LNG.app_create, icon: "puzzle-piece", className: "line_top newfile"}
            }
        },
        listIcon: {
            name: LNG.list_type,
        ...
        $('<i class="menuRecycleBody"></i>').appendTo("#rightMenu"), $.contextMenu({
            ...
            items: {recycle_clear: {name: LNG.recycle_clear, icon: "trash", accesskey: "c"}}
        })
    }, _bindShare = function () {
        $('<i class="menuShareBody"></i>').appendTo("#rightMenu"), $.contextMenu({
            ...
            items: {
                share_open_path: {name: LNG.share_open_path, icon: "folder-open-alt", accesskey: "p"},
                share_open_window: {name: LNG.share_open_page, icon: "globe", accesskey: "b"},
                sep1: "--------",
                share_edit: {name: LNG.share_edit, icon: "edit", accesskey: "e"},
                remove: {name: LNG.share_remove + "<b>Del</b>", icon: "trash", accesskey: "d"},
                sep2: "--------",
                info: {name: LNG.info + "<b>Alt+I</b>", className: "info", icon: "info", accesskey: "i"}
            }
            ...
            items: {remove: {name: LNG.share_remove + "<b>Del</b>", icon: "trash", accesskey: "d"}}
        })
        ...
        $('<i class="' + fileMenuSelector.substr(1) + '"></i>').appendTo("#rightMenu"), $.contextMenu({
            ...
            items: {
                ...
                setBackground: {name: LNG.set_background, className: "setBackground", icon: "download", accesskey: "x"},
                others: {
                    name: LNG.more,
                    icon: "ellipsis-horizontal",
                    accesskey: "m",
        ...
        $('<i class="taskBarMenu"></i>').appendTo("#rightMenu"), $.contextMenu({
            ...
            callback: function (e, a) {
                var t = a.$trigger.attr("id"), i = art.dialog.list[t];
                switch (e) {
                    case"quitOthers":
    ...
    return {
        ...
        show: function (e, a, t) {
            e && (rightMenu.hidden(), $(e).contextMenu({x: a, y: t}))
        },
        menuShow: function () {
            var e = $(".context-menu-list").filter(":visible"), a = $(".context-menu-active");
            if (0 != e.length && 0 != a.length) {
                ...
                if (a.hasClass("dialog_menu")) {
                    var i = a.attr("id"), n = art.dialog.list[i];
        ...
        menuCurrentPath: function (e) {
            var a = ".createLink,.createProject,.cute,.remove,.rname,.zip,.unzip,.newfile,.newfolder,.newfileOther,.app_create,.app_install,.past,.upload,.clone", t = "disable";
    ...
    var e = !1, a = !1, t = !1, i = function () {
        ...
        $(Config.FileBoxClass).die("touchstart").live("touchstart", function () {
            ...
            a && ($(this).hasClass(Config.TypeFolderClass) && !$(this).hasClass(Config.SelectClassName) || $(this).hasClass("menuRecycleButton")) && $(this).addClass("selectDragTemp"), e || a || $(this).addClass(Config.HoverClassName), $(this).unbind("mousedown").mousedown(function (e) {
                if (rightMenu.hidden(), e.ctrlKey || e.shiftKey || $(this).hasClass(Config.SelectClassName) || (d.clear(), $(this).addClass(Config.SelectClassName), d.select()), 3 != e.which || $(this).hasClass(Config.SelectClassName) || (d.clear(), $(this).addClass(Config.SelectClassName), d.select()), e.ctrlKey && ($(this).hasClass(Config.SelectClassName) ? t = !0 : (d.setMenu($(this)), $(this).addClass(Config.SelectClassName)), d.select()), e.shiftKey) {
                    ...
                    if (0 == Global.fileListSelectNum)c(0, a); else {
        ...
        var t, i, n, s = 100, o = 50, r = 30, l = 80 - Global.topbar_height, c = 0, p = !1, u = 0, h = 0;
        ...
        var f = function (e) {
            ...
            if (!a)return !0;
            $.now() - c > s && !p && _();
            var t = e.clientX >= n - 50 ? n - 50 : e.clientX, r = e.clientY >= i - 50 ? i - 50 : e.clientY;
            t = 0 >= t ? 0 : t, r = 0 >= r ? 0 : r, t -= o, r -= l, $(".draggable-dragging").css("left", t), $(".draggable-dragging").css("top", r), Global.isIE && $("." + Config.TypeFolderClass + ",div.menuRecycleButton").each(function () {
                var a = e.pageX, t = e.pageY, i = $(this).offset(), n = $(this).width(), s = $(this).height();
            ...
            var t = G.this_path, i = 0 == $(".selectDragTemp").length;
        ...
        var s = function (a) {
            ...
            var s = a.pageX, o = a.pageY - Global.topbar_height;
            n.css({left: Math.min(s, t), top: Math.min(o, i), width: Math.abs(s - t), height: Math.abs(o - i)});
            for (var r = n.offset().left, l = n.offset().top - Global.topbar_height, c = n.width(), p = n.height(), u = Global.fileListNum, h = 0; u > h; h++) {
                var f = Global.fileListAll[h], m = $(Global.fileListAll[h]), v = f.offsetWidth + f.offsetLeft, _ = f.offsetHeight + f.offsetTop;
        ...
        var a = 0, t = Global.fileListSelect;
        ...
        var i = Global.fileListNum, n = function () {
            ...
            if (1 == Global.fileListSelectNum) {
                ...
                var o = parseInt(t.first().attr(Config.FileOrderAttr)), r = parseInt(t.last().attr(Config.FileOrderAttr));
                switch (e) {
                    case"up":
                        a = a = 0 >= o ? o : o - 1;
                        break;
        ...
        init: function () {
            ...
            var a = {fileBox: "menufile", folderBox: "menufolder", systemBox: "menuDefault"};
    ...
    return {init: i, fileLight: d, selectPos: l}
    ...
    var a = function () {
        ...
        0 != e && (G.sort_field = e, $(".menu_set_sort").removeClass("selected"), $(".set_sort_" + e).addClass("selected")), 0 != a && (G.sort_order = a, $(".menu_set_desc").removeClass("selected"), $(".set_sort_" + a).addClass("selected")), r(!1, !0), $.ajax({url: "vis.go?setting/set&k=list_sort_field,list_sort_order&v=" + G.sort_field + "," + G.sort_order})
    }, n = function () {
        var e = 91;
        Global.ctrlKey = !1, $(document).keydown(function (a) {
            ...
            if (Global.ctrlKey || a.keyCode == e || a.ctrlKey)switch (t = !0, Global.ctrlKey = !0, a.keyCode) {
                ...
                default:
                    t = !1
            } else if (a.shiftKey)Global.shiftKey = !0; else switch (a.keyCode) {
                case 8:
                    t = !0;
                    break;
                case 35:
    ...
    this._hover_title = function (e) {
        ...
        if ("oexe" == e.ext && void 0 != e.icon) {
            var t = e.icon;
            -1 == e.icon.search(G.static_path) && "http" != e.icon.substring(0, 4) && (t = G.static_path + "images/app/" + e.icon);
            ...
            var s = core.path2url(G.this_path + e.name), o = "vis.go?explorer/image&path=" + urlEncode(G.this_path + e.name);
    ...
    var o = function (e) {
        var i = "", n = G.json_data.folderlist, o = G.json_data.filelist;
        ...
        if (void 0 == e && (e = !0), void 0 == a && (a = !1), e)$.ajax({
            url: "vis.go?explorer/pathList&type=desktop&path=" + G.this_path,
            dataType: "json",
            error: core.ajaxError,
            success: function (e) {
            ...
            url: "vis.go?explorer/pathList&type=desktop&path=*recycle*/",
            dataType: "json",
            error: core.ajaxError,
            success: function (e) {
                if (!e.code)return !1;
    ...
    return {
        f5: r, f5_callback: l, picasa: e, setListSort: i, sort_list: s, init: function () {
            ...
            }), PicasaOpen = !1, e.init(".picasaImage"), e.initData(), G.isIE || $(".wallbackground").addClass("hidden")
        }, setTheme: function (e) {
            ...
            Global.fileRowNum = function () {
                var e = $(Config.FileBoxSelector).width(), a = $sizeInt($(Config.FileBoxClass).css("width")) + $sizeInt($(Config.FileBoxClass).css("border-left-width")) + $sizeInt($(Config.FileBoxClass).css("border-right-width")) + $sizeInt($(Config.FileBoxClass).css("margin-right"));
                return parseInt(e / a)
            }()
        }
    }
    ...
    var a = e("../../common/pathOperate"), t = e("../../common/pathOpen"), n = void 0;
    ui.pathOpen = t;
    var s = function (e, a, t) {
        ...
        var t, i, n = 0, s = G.json_data.folderlist, o = G.json_data.filelist;
        ...
        if ("" != e) {
            if (e = e.toLowerCase(), void 0 == n || G.this_path != n.path || e != n.key) {
                ...
                }), n = {key: e, path: G.this_path, index: 0, list: a}
            }
        ...
        $.ajax({
            dataType: "json", url: "vis.go?explorer/historyBack", beforeSend: function () {
        ...
        $.ajax({
            dataType: "json", url: "vis.go?explorer/historyNext", beforeSend: function () {
                $(".tools-left .msg").stop(!0, !0).fadeIn(100)
            }, error: core.ajaxError, success: function (e) {
                return $(".tools-left .msg").fadeOut(100), e.code ? (e = e.data, G.this_path = e.thispath, G.json_data = e.list, Global.historyStatus = e.history_status, ui.f5(!1, !0), ui.header.updateHistoryStatus(), ui.header.addressSet(), void 0) : (core.tips.tips(e), $(Config.FileBoxSelector).html(""), !1)
            }
        ...
        var t = "newfile", t = u(t, e), i = o(t, "file");
        i = 0 == i ? -1 : i - 1;
        var n = '<div class="file select menufile"  id="makefile">			<div class="' + e + ' ico"></div>				<div class="titleBox">					<span class="title">					<div class="textarea">						<textarea class="newfile fix">' + t + '</textarea>					</span>				</div>			</div>			<div style="clear:both;"></div>		</div>';
        ...
        var s = $(".newfile"), l = s.get(0), c = t.length - e.length - 1;
        if (Global.isIE) {
        ...
        fileLight.clear();
        var e = LNG.newfolder, e = u(e), t = o(e, "folder");
        t = 0 == t ? -1 : t - 1;
        ...
        var e = "", t = "", i = Global.fileListSelect, n = fileLight.name(i), s = fileLight.type(i);
        if (1 == i.length) {
            ...
            var o = $("#pathRenameTextarea"), l = o.get(0);
            if ("folder" == s)o.select(); else {
        ...
        if (e) {
            ...
            return 0 == Global.fileListSelect.length ? a : (Global.fileListSelect.each(function () {
                var e = G.this_path + fileLight.name($(this)), t = "folder" == fileLight.type($(this)) ? "folder" : "file";
                "*share*/" == G.this_path && (e = $(this).attr("data-path"), t = "share"), a.push({path: e, type: t})
            }), a)
        }
        if (1 != Global.fileListSelectNum)return {path: "", type: ""};
        var t = Global.fileListSelect, i = G.this_path + fileLight.name(t), n = fileLight.type(t);
        return "*share*/" == G.this_path && (i = t.attr("data-path"), n = "share"), {path: i, type: n}
    };
    return {
        appEdit: function (e) {
            if (e)a.appEdit(0, 0, "user_add"); else {
                var t = Global.fileListSelect.attr("data-app"), i = json_decode(urlDecode(t));
        ...
        setBackground: function () {
            a.setBackground(b().path)
        },
        createLink: function () {
            a.createLink(b().path, b().type, function (e) {
                ui.f5_callback(function () {
                    r(e.info)
                })
            })
        ...
        createProject: function () {
            a.createProject(b().path, function (e) {
                ui.f5_callback(function () {
                    r(e.info)
                })
            })
        ...
        download: function () {
            var e = b(!0);
            1 == e.length && "file" == e[0].type ? t.download(b().path) : a.zipDownload(e)
        },
        share_edit: function () {
            var e = b().path, t = G.json_data.share_list[e];
            a.share_box(t)
        },
        share_open_window: function () {
            var e = b().path, a = G.json_data.share_list[e], t = a.type;
            "folder" == a.type && (t = 1 == a.code_read ? "code_read" : "folder");
            var i = "./vis.go?share/" + t + "&user=" + G.user_name + "&sid=" + a.sid;
            window.open(i)
        },
        share_open_path: function () {
            var e = b().path, a = G.json_data.share_list[e], t = core.pathFather(a.path), i = core.pathThis(a.path);
        ...
        recycle_clear: function () {
            $.dialog({
                ...
                ok: function () {
                    $.ajax({
                        url: "vis.go?explorer/pathDeleteRecycle", beforeSend: function () {
                            core.tips.loading()
                        }, error: core.ajaxError, success: function (e) {
        ...
        explorerNew: function () {
            window.open("vis.go?/explorer&path=" + b().path)
        },
        ...
        remove: function () {
            a.remove(b(!0), g), fileLight.clear()
        },
        copy: function () {
            a.copy(b(!0))
        },
        ...
        unZip: function () {
            a.unZip(b().path, ui.f5)
        },
        cuteDrag: function (e) {
            a.cuteDrag(b(!0), e, g)
        },
        copyDrag: function (e, t) {
            a.copyDrag(b(!0), e, function (e) {
        ...
        info: function () {
            if ("share" == b().type) {
                var e = b().path, t = G.json_data.share_list[e], i = t.path;
                a.info([{path: i, type: t.type}])
            } else a.info(b(!0))
        },
        past: function () {
    ...
    var t = ["/", "\\", ":", "*", "?", '"', "<", ">", "|"], i = function (e) {
        ...
        if (!(1 > e.length)) {
            var t = e[0].path, i = LNG.remove_title, s = t + "<br/><br/>" + LNG.remove_info, o = "vis.go?explorer/pathDelete";
            "*recycle*/" == G.this_path && (s = LNG.recycle_remove + "?", o = "vis.go?explorer/pathDeleteRecycle", i = LNG.recycle_remove), "share" == e[0].type && (s = LNG.share_remove_tips, o = "vis.go?userShare/del", i = LNG.share_remove), e.length > 1 && (s += ' ... <span class="badge">' + e.length + "</span>"), $.dialog({
                id: "dialog_path_remove",
                fixed: !0,
                icon: "question",
                title: i,
                ...
                ok: function () {
                    $.ajax({
                        url: o, type: "POST", dataType: "json", data: n(e), beforeSend: function () {
                            core.tips.loading()
                        }, error: core.ajaxError, success: function (t) {
                            if (core.tips.close(t), FrameCall.father("ui.f5", ""), "share" == e[0].type) {
        ...
        var a = e.path, t = "folder" == e.type ? "folder" : "file";
        1 > a.length || core.authCheck("userShare:set") && $.ajax({
            url: "./vis.go?userShare/checkByPath&path=" + urlEncode(a),
            dataType: "json",
            success: function (e) {
        ...
        var t = e("../tpl/share.html"), i = template.compile(t), n = i({LNG: LNG});
        $.dialog({
            id: "share_dialog",
            simple: !0,
            resize: !1,
        ...
        var o = function (e) {
            ...
            $(".share_action .share_remove_button").unbind("click").click(function () {
                ui.pathOperate.remove([{type: "share", path: a.sid}]), "*share*/" == G.this_path && ui.f5()
            ...
            var e = $("input.share_url"), t = e.get(0);
        ...
        if (!(1 > e.length)) {
            ...
            FrameCall.father("ui.setWall", '"' + a + '"'), $.ajax({
                url: "vis.go?setting/set&k=wall&v=" + urlEncode(a),
                type: "json",
                success: function (e) {
                    core.tips.tips(e)
                }
        ...
        if (!(1 > e.length)) {
            var t = core.pathThis(e), i = core.pathFather(e);
        ...
        if (e) {
            var t = "vis.go?explorer/pathPast&path=" + urlEncode2(e);
            $.ajax({
                url: t, dataType: "json", beforeSend: function () {
        ...
        var t = "vis.go?explorer/pathInfo";
        G.share_page !== void 0 && (t = "vis.go?share/pathInfo&user=" + G.user + "&sid=" + G.sid), $.ajax({
            url: t,
            type: "POST",
            dataType: "json",
            data: n(e),
            ...
            success: function (t) {
                ...
                var s = template.compile(a[i]), o = UUID();
        ...
        var t = $("." + e);
        t.find(".open_window").bind("click", function () {
            window.open(t.find("input.download_url").val())
        });
        var i = t.find("input.download_url"), s = i.get(0);
        i.unbind("hover click").bind("hover click", function () {
            $(this).focus();
            var e = i.val().length;
            if (Global.isIE) {
                var a = s.createTextRange();
                a.moveEnd("character", -s.value.length), a.moveEnd("character", e), a.moveStart("character", 0), a.select()
            } else s.setSelectionRange(0, e)
        }), t.find(".edit_chmod").click(function () {
            var e = $(this).parent().find("input"), t = $(this);
            $.ajax({
                url: "vis.go?explorer/pathChmod&mod=" + e.val(), type: "POST", data: n(a), beforeSend: function () {
                    t.text(LNG.loading)
                }, error: function () {
                    t.text(LNG.button_save)
                }, success: function (e) {
                    t.text(e.data).animate({opacity: .6}, 400, 0).delay(1e3).animate({opacity: 1}, 200, 0, function () {
                        t.text(LNG.button_save)
                    })
                }
            })
        ...
        if (core.authCheck("explorer:fileDownload") && !(1 > e.length)) {
            var a = "vis.go?explorer/zipDownload";
            G.share_page !== void 0 && (a = "vis.go?share/zipDownload&user=" + G.user + "&sid=" + G.sid), $.ajax({
                url: a, type: "POST", dataType: "json", data: n(e), beforeSend: function () {
                    core.tips.loading(LNG.zip_download_ready)
                }, error: core.ajaxError, success: function (e) {
                    core.tips.close(e), core.tips.tips(e);
                    var a = "vis.go?explorer/fileDownloadRemove&path=" + urlEncode2(e.info);
                    G.share_page !== void 0 && (a = "vis.go?share/fileDownloadRemove&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e.info));
                    var t = '<iframe src="' + a + '" style="width:0px;height:0px;border:0;" frameborder=0></iframe>' + LNG.download_ready + "...", i = $.dialog({
                        icon: "succeed",
                        title: !1,
                        time: 1.5,
                        content: t
        ...
        if (e) {
            var t = "vis.go?explorer/unzip&path=" + urlEncode2(e);
            $.ajax({
        ...
        a && (void 0 == i && (i = 0), $.ajax({
            ...
            type: "POST",
            dataType: "json",
            data: n(e) + "&path=" + urlEncode2(a + "/") + "&filename_auto=" + Number(i),
            beforeSend: function () {
                core.tips.loading(LNG.moving)
            },
            error: core.ajaxError,
        ...
        var n, s, o, r = LNG.app_create, l = UUID(), c = e("../tpl/app.html"), d = G.basic_path + "static/images/app/", p = template.compile(c);
        switch (void 0 == i && (i = "user_edit"), "root_edit" == i && (a = a), "user_edit" == i || "root_edit" == i ? (r = LNG.app_edit, o = p({
            LNG: LNG,
            iconPath: d,
            uuid: l,
            data: a
        })) : o = p({LNG: LNG, iconPath: d, uuid: l, data: {}}), $.dialog({
            fixed: !0,
            width: 450,
            id: l,
            padding: 15,
                ...
                name: LNG.button_save, focus: !0, callback: function () {
                    ...
                    switch (i) {
                        case"user_add":
                            ...
                            s = "./vis.go?app/user_app&action=add&path=" + o;
                            break;
                        case"user_edit":
                            s = "./vis.go?app/user_app&path=" + urlEncode2(a.path);
                            break;
                        case"root_add":
                            s = "./vis.go?app/add&name=" + e.name;
                            break;
                        case"root_edit":
                            s = "./vis.go?app/edit&name=" + e.name + "&old_name=" + a.name;
                            break;
                        default:
                    }
                    $.ajax({
    ...
    var a = function (e, a) {
        ...
        $.dialog({fixed: !0, icon: "warning", title: LNG.unknow_file_title, padding: 30, content: t, cancel: !0})
    }, i = function (e) {
        if (core.authCheck("explorer:fileDownload", LNG.no_permission_download) && e) {
            var a = "vis.go?explorer/fileDownload&path=" + urlEncode2(e);
            G.share_page !== void 0 && (a = "vis.go?share/fileDownload&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e));
            var t = '<iframe src="' + a + '" style="width:0px;height:0px;border:0;" frameborder=0></iframe>' + LNG.download_ready + "...", i = $.dialog({
                icon: "succeed",
                title: !1,
                time: 1,
        ...
        if (core.authCheck("explorer:fileDownload", LNG.no_permission_download) && e) {
            var t = core.pathExt(e), i = core.pathThis(e);
        ...
        var a = "./vis.go?explorer/officeView&path=" + urlEncode(e);
        if (G.share_page !== void 0)var a = G.app_host + "vis.go?share/officeView&user=" + G.user + "&sid=" + G.sid + "&path=" + urlEncode2(e);
        art.dialog.open(a, {
            ico: core.ico("doc"),
    ...
    return {open: a, play: l, openEditor: o, openIE: n, download: i}
    ...
    var e = {
        ...
        var r = core.createFlash(G.static_path + "js/lib/cmp4/cmp.swf", "context_menu=2&auto_play=1&play_mode=1&skin=skins/" + t.path + ".zip", a), l = {
            id: a + "_dialog",
            simple: !0,
            ico: o,
            title: i,
        ...
        for (a = e.length - 1; a >= 0; a--) {
            var i, n;
            -1 == e[a].search("fileProxy") ? (i = urlEncode(e[a]), n = core.pathThis(e[a])) : (i = e[a], n = core.pathThis(urlDecode(i))), i = i.replace(/%2F/g, "/"), i = i.replace(/%3F/g, "?"), i = i.replace(/%26/g, "&"), i = i.replace(/%3A/g, ":"), i = i.replace(/%3D/g, "="), t += '<list><m type="" src="' + i + '" label="' + n + '"/></list>'
        }
        return t
    }, n = function (e) {
    ...
    return {
        changeTheme: function (a, t) {
            ...
            var r = a(i), l = n(r);
            if (l)s(e, r), o(r), window.top.art.dialog.list[r + "_dialog"].display(!0); else {
                t(r);
...
var new_play = function (e) {
    ...
    var t = function (e) {
        var a = '<object id="the_wmp_player" ', t = navigator.userAgent;
