define("app/src/setting/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "./setting", "./fav", "./group", "./member", "./system"], function (e) {
    e("lib/jquery-lib"), e("lib/util"), e("lib/artDialog/jquery-artDialog"), core = e("../../common/core"), Setting = e("./setting"), Fav = e("./fav"), Group = e("./group"), Member = e("./member"), System = e("./system"), Setting.init(), Fav.bindEvent(), Member.bindEvent(), Group.bindEvent(), System.bindEvent()
    ...
    var e, t = function (e) {
        ...
        ("" == t || void 0 == t) && (t = "user"), e = t, "fav&" == t.substring(0, 4) && (t = "fav"), $(".selected").removeClass("selected"), $("ul.setting li#" + t).addClass("selected"), window.location.href = "#" + t, $.ajax({
            url: "./vis.go?setting/slider&slider=" + t,
            beforeSend: function () {
        ...
        G.is_root ? $("ul.setting #system").show() : $("ul.setting #system").hide(), G.is_root || 1 == AUTH["member:get"] ? $("ul.setting #member").show() : $("ul.setting #member").hide(), e = location.hash.split("#", 2)[1], i(e), $("ul.setting li").hover(function () {
            ...
            var n = "vis.go?setting/set&k=" + type + "&v=" + value;
            $.ajax({
                url: n, type: "json", success: function (e) {
        ...
        switch (e) {
            case"user":
                var t = $("#password_now").val(), a = $("#password_new").val();
                if ("" == a || "" == t) {
                    tips(LNG.password_not_null, "error");
                    break
                }
                $.ajax({
                    url: "vis.go?user/changePassword&password_now=" + t + "&password_new=" + a,
                    dataType: "json",
                    success: function (e) {
                        tips(e), e.code && (window.top.location.href = "./vis.go?user/logout")
                    }
                });
                break;
            case"wall":
                ...
                var n = "vis.go?setting/set&k=wall&v=" + urlEncode(i);
                $.ajax({
                    url: n, type: "json", success: function (e) {
                        tips(e)
                    }
    ...
    return {init: n, setGoto: i, tools: o, setThemeSelf: a, setTheme: t}
}), define("app/src/setting/fav", [], function () {
    var e = "vis.go?fav/", t = function (t) {
        var a;
        $.ajax({
            url: e + "get", dataType: "json", async: !1, success: function (e) {
        ...
        for (var n in a)i += "<tr class='favlist' name='" + a[n].name + "' path='" + a[n].path + "'>" + "   <td class='name'><input type='text' id='sname' value='" + a[n].name + "' /></td>" + "   <td class='path'><input type='text' id='spath' value='" + a[n].path + "' /></td>" + "   <td class='action'>" + "       <a href='javascript:void(0)' onclick='' class='button edit'>" + LNG.button_save_edit + "</a>" + "       <a href='javascript:void(0)' onclick='' class='button del'>" + LNG.button_del + "</a>" + "   </td>" + "</tr>";
        if ($("table#list").html(i), "fav&" == t.substring(0, 4)) {
            var o = t.split("&")[1].split("=")[1], s = t.split("&")[2].split("=")[1], r = "<tr class='favlist' name='' path=''>   <td class='name'><input type='text' id='sname' value='" + urlDecode(o) + "' /></td>" + "   <td class='path'><input type='text' id='spath' value='" + urlDecode(s) + "' /></td>" + "   <td class='action'>" + "       <a href='javascript:void(0)' class='button addsave'>" + LNG.button_save + "</a>" + "       <a href='javascript:void(0)' class='button addexit'>" + LNG.button_cancel + "</a>" + "   </td>" + "</tr>";
        ...
        var t = $(this).parent().parent(), a = $(t).find("#sname").val(), i = $(t).find("#spath").val();
        ...
        var t = $(this).parent().parent(), a = $(t).attr("name"), i = $(t).find("#sname").val(), n = $(t).find("#spath").val();
        ...
        var t = $(this).parent().parent(), a = $(t).attr("name");
        $.ajax({
            url: e + "del&name=" + a, dataType: "json", async: !1, success: function (e) {
    ...
    return {init: t, bindEvent: r}
}), define("app/src/setting/group", [], function () {
    var e = "vis.go?group/", t = {}, a = function () {
        $.ajax({
            url: e + "get", dataType: "json", async: !1, success: function (e) {
        ...
        for (var a in t) {
            ...
            "root" == t[a].role && (i = LNG.default_group_can_not_do), e += "<tr role='" + t[a].role + "'>" + "   <td>" + t[a].role + "</td>" + "   <td>" + t[a].name + "</td><td>" + i + "</td>"
        }
        ...
        a = t[e], $(".group_editor .tag").removeClass("this"), $(".group_editor input").removeAttr("checked"), $(".group_editor .edit_save").removeClass("hidden"), $(".group_editor .edit_exit").removeClass("hidden"), $(".group_editor .add_save").addClass("hidden"), $(".nav .group_status").html(LNG.setting_group_edit), l($(".nav .group_status")), $(".group_editor #role").val(a.role).attr("data-before", a.role), $(".group_editor #name").val(a.name), $(".group_editor #ext_not_allow").val(a.ext_not_allow), $(".group_editor .tag").each(function () {
            var e = $(this), t = e.attr("data-role");
            t = t.split(";"), t = t[0], a[t] && (e.addClass("this"), e.find("input").attr("checked", !0))
        })
    }, s = function () {
        var t = $(".group_editor #role").val(), i = $(".group_editor #name").val(), o = $(".group_editor #ext_not_allow").val(), s = {}, r = "", l = "add";
        ...
        $.ajax({
            url: e + r, data: s, type: "POST", dataType: "json", success: function (e) {
                tips(e), e.code && (a(), "add" == l && n())
            }
        })
    }, r = function () {
        var t = $(this).parent().parent(), i = $(t).attr("role");
        $.dialog({
            fixed: !0,
            icon: "question",
            drag: !0,
            ...
            ok: function () {
                $.ajax({
                    url: e + "del&role=" + i, async: !1, dataType: "json", success: function (e) {
    ...
    return {getData: d, edit: o, init: a, bindEvent: c}
}), define("app/src/setting/member", [], function () {
    var e, t = "vis.go?member/", a = "", i = {}, n = function () {
        i = Group.getData(), $.ajax({
            url: t + "get", dataType: "json", async: !1, success: function (t) {
        ...
        var t = "<tr class='title'><td width=''>" + LNG.username + "</td>" + "<td width='25%'>" + LNG.group_name + "</td>" + "<td width='35%'>" + LNG.action + "</td>" + "</tr>", n = objectKeys(i);
        a = "";
        ...
        var n = "<a href='javascript:void(0)' class='button folder'>" + LNG.address + "</a>  " + "<a href='javascript:void(0)' class='button edit'>" + LNG.button_edit + "</a>  " + "<a href='javascript:void(0)' class='button del'>" + LNG.button_del + "</a>";
        ...
        } : {b1: "edit_save'>" + LNG.button_save_edit, b2: "edit_exit'>" + LNG.button_cancel};
        ...
        var e = $(this).parent().parent(), a = urlEncode($(e).find("#name").val()), i = urlEncode($(e).find("#password").val()), n = $(e).find("#role").val();
        return "" == a || "" == i || "" == n ? (tips(LNG.not_null, "warning"), !1) : ($.ajax({
            url: t + "add&name=" + a + "&password=" + i + "&role=" + n,
            dataType: "json",
            success: function (t) {
                if (tips(t), t.code) {
                    var i = s(a, n);
                    $(i).insertAfter(e), $(e).detach()
                }
            }
        }), void 0)
    }, p = function () {
        var e = $(this).parent().parent(), t = r("edit", $(e).attr("name"), $(e).attr("role"));
        $(".info").html(LNG.password_null_not_update).fadeIn(100), $(t).insertAfter(e);
        var a = $(e).attr("role");
        $(e).next().find("option[value=" + a + "]").attr("selected", "true"), $(e).detach()
    }, u = function () {
        var e = $(this).parent().parent(), t = s($(e).attr("name"), $(e).attr("role"));
        $(t).insertAfter(e), $(e).detach(), $(".info").fadeOut(100)
    }, h = function () {
        var e = $(this).parent().parent(), a = urlEncode($(e).attr("name")), i = urlEncode($(e).find("#name").val()), n = $(e).find("#role").val(), o = urlEncode($(e).find("#password").val());
        if ("" == i || "" == n)return tips(LNG.not_null, "error"), !1;
        var r = "";
        "" != o && (r = "&password_to=" + o), $.ajax({
            url: t + "edit&name=" + a + "&name_to=" + i + "&role_to=" + n + r,
            dataType: "json",
            success: function (t) {
                if (tips(t), t.code) {
                    var a = s(i, n);
                    $(a).insertAfter(e), $(e).detach(), $(".info").fadeOut(100)
                }
            }
        })
    }, f = function () {
        var e = $(this).parent().parent(), a = $(e).attr("name");
        $.dialog({
            fixed: !0,
            icon: "question",
            drag: !0,
            title: LNG.warning,
            content: LNG.if_remove + a + "<br/>" + LNG.member_remove_tips,
            ok: function () {
                $.ajax({
                    url: t + "del&name=" + a, dataType: "json", async: !1, success: function (t) {
                        tips(t), t.code && $(e).detach()
                    }
                })
            },
            cancel: !0
        ...
        $(".member a.add").live("click", l), $(".member a.add_exit").live("click", c), $(".member a.add_save").live("click", d), $(".member a.edit").live("click", p), $(".member a.edit_save").live("click", h), $(".member a.edit_exit").live("click", u), $(".member a.del").live("click", f), $(".member a.folder").live("click", function () {
            ...
            return "" == e ? (tips(LNG.group_already_remove, !1), void 0) : (Group.edit(e), void 0)
        })
    };
    return {init: n, bindEvent: m}
    ...
    var e = function () {
        $("input[name='first_in']").live("click", function () {
            ...
            $(".system_setting .box_line input").each(function () {
                ...
                if ("checkbox" == t.attr("type")) {
                    ...
                    e[t.attr("name")] = a
                } else"radius" != t.attr("type") && (e[t.attr("name")] = urlEncode(t.val()))
            }), e.first_in = $("input[name='first_in'][checked]").val(), a(e)
        }), t(), $(".path_ext_tips").die("click").live("click", function () {
            art.dialog.open("./vis.go?setting/php_info", {title: "php_info", width: "70%", height: "65%", resize: !0})
        })
    }, t = function () {
        $('.setting_menu .menu_list input[name="target"]').live("click", function () {
            ...
            var e = $(this).parent().parent();
            e.hasClass("menu_hidden") ? (e.removeClass("menu_hidden"), $(this).text(LNG.menu_hidden)) : (e.addClass("menu_hidden"), $(this).text(LNG.menu_show))
            ...
            $(".setting_menu .menu_list").each(function () {
                ...
                }), "" != a.name && (a.use = "1", a.type = "", t.hasClass("menu_hidden") && (a.use = "0"), t.hasClass("menu_system") && (a.type = "system"), e.push(a)))
            }), a({menu: e})
        })
    }, a = function (e) {
        $.ajax({
            url: "vis.go?setting/system_setting",
            type: "POST",
