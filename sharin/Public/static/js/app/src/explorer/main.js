define("app/src/explorer/main", ["lib/jquery-lib", "lib/util", "lib/ztree/js/ztree", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "lib/picasa/picasa", "./ui", "./fileSelect", "../../common/taskTap", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../common/rightMenu", "../../common/tree", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer", "./path"], function (e) {
    Config = {
        ...
        TreeId: "folderList",
        pageApp: "explorer",
        treeAjaxURL: "vis.go?explorer/treeList&app=explorer",
        AnimateTime: 200
    }, Global = {
        fileListAll: "",
        fileListNum: 0,
        ...
        $(".init_loading").fadeOut(450).addClass("pop_fadeout"), Global.topbar_height = "none" == $(".topbar").css("display") ? 0 : $(".topbar").height(), e.async("lib/webuploader/webuploader-min", function () {
            core.upload_init()
        }), ui.init(), ui.tree.init(), TaskTap.init(), core.update(), fileSelect.init(), rightMenu.initExplorer(), $(".path_tips").tooltip({
            placement: "bottom",
            html: !0
        })
    })
    ...
    var _ajaxLive = function () {
        ...
        G.list_type = e, void 0 == t ? $.ajax({
            url: "vis.go?setting/set&k=list_type&v=" + e,
            dataType: "json",
            success: function () {
        ...
        0 != e && (G.sort_field = e, $(".menu_set_sort").removeClass("selected"), $(".set_sort_" + e).addClass("selected")), 0 != t && (G.sort_order = t, $(".menu_set_desc").removeClass("selected"), $(".set_sort_" + t).addClass("selected")), _f5(!1, !0), $.ajax({url: "vis.go?setting/set&k=list_sort_field,list_sort_order&v=" + G.sort_field + "," + G.sort_order})
        ...
        $(".dropdown-menu-theme li").click(function () {
            ...
            $.ajax({
                url: "vis.go?setting/set&k=theme&v=" + e, dataType: "json", success: function (t) {
        ...
        var e = !1, t = 0, a = 0, i = 0, n = $(".frame-left"), s = $(".frame-left .bottom_box"), o = $(".frame-resize"), r = $(".frame-right");
    ...
    this._hover_title = function (e) {
        ...
        if ("number" == typeof e.exists && 0 == e.exists && (a = '<b style="color:red;">' + a + "</b>"), "oexe" == e.ext && void 0 != e.icon) {
            var i = e.icon;
            -1 == e.icon.search(G.static_path) && "http" != e.icon.substring(0, 4) && (i = G.static_path + "images/app/" + e.icon);
        ...
        if ("number" == typeof e.exists && 0 == e.exists && (a = '<b style="color:red;">' + a + "</b>"), "oexe" == e.ext) {
            ...
            var n = core.path2url(G.this_path + e.name), s = "vis.go?explorer/image&path=" + urlEncode(G.this_path + e.name);
    ...
    var pathTypeChange = function () {
        ...
        var n = "_getFileBox", s = "_getFolderBox", o = "", r = "";
        ...
        if (void 0 == e && (e = !0), void 0 == t && (t = !1), _jsonSortTitle(), e)$.ajax({
            url: "vis.go?explorer/pathList&path=" + urlEncode(G.this_path),
            dataType: "json",
            beforeSend: function () {
        ...
        header: {
            bindEvent: function () {
                ...
                var t = function (e) {
                    ...
                    var i = e.split("/");
                    "" == i[i.length - 1] && i.pop();
                    var n = i[0] + "/", s = t.replace(/@1@/g, n), o = i[0];
                    "" != i[0] && ("*share*" == o ? o = LNG.my_share : "*public*" == o ? o = LNG.public_path : "*recycle*" == o && (o = LNG.recycle)), s = s.replace("{$2}", i.length), s = s.replace("{$3}", o);
                ...
                var e = $("input.path").val();
                if ("/" == e)return core.tips.tips("已经到根目录了!", "warning"), void 0;
                var t = e.length - 1, a = "", i = e.split("/").length - 1;
                if (1 == i)a = e; else {
                    "/" == e.substr(t, 1) && (t -= 1);
    ...
    var e = !1, t = !1, a = !1, i = function () {
        ...
        var a, i, n, s = 100, o = 50, r = 30, l = 80 - Global.topbar_height, c = 0, p = !1, u = 0, h = 0;
        ...
        var f = function (e) {
            ...
            if (!t)return !0;
            $.now() - c > s && !p && _();
            var a = e.clientX >= n - 50 ? n - 50 : e.clientX, r = e.clientY >= i - 50 ? i - 50 : e.clientY;
            a = 0 >= a ? 0 : a, r = 0 >= r ? 0 : r, a -= o, r -= l, $(".draggable-dragging").css("left", a), $(".draggable-dragging").css("top", r), Global.isIE && $("." + Config.TypeFolderClass).each(function () {
                var t = e.pageX, a = e.pageY, i = $(this).offset(), n = $(this).width(), s = $(this).height();
            ...
            var a = G.this_path, i = 0 == $(".selectDragTemp").length;
        ...
        var a = null, i = null, n = null, s = 85 + Global.topbar_height, o = 0, r = 0;
        ...
        var l = function (t) {
            ...
            var s = $(Config.BodyContent).scrollTop() - o, l = t.pageX - Global.frameLeftWidth, c = t.pageY - r + s;
        ...
        var i = Global.fileListNum, n = function () {
            if (1 == Global.fileListSelectNum) {
                ...
                var s = parseInt(a.first().attr(Config.FileOrderAttr)), o = parseInt(a.last().attr(Config.FileOrderAttr));
                switch (e) {
                    case"up":
                    case"left":
                        t = 0 >= s ? s : s - 1;
            ...
            if (1 == Global.fileListSelectNum) {
                ...
                var o = parseInt(a.first().attr(Config.FileOrderAttr)), r = parseInt(a.last().attr(Config.FileOrderAttr));
                switch (e) {
                    case"up":
                        t = n >= o ? o : o - n;
                        break;
    ...
    var e = {}, t = "", a = 160, i = function () {
        ...
        var e, t, i, n, s = !1, o = !1, r = 0, l = 0, c = 0, d = 0, p = 0, u = 0;
        ...
        var h = function (a) {
            ...
            var n = e.get(0).getBoundingClientRect().top - $sizeInt(e.css("margin-top")), o = a.clientX - r + l;
            ...
            if (!e.is(":animated") || n != i) {
                ...
                "left" == s ? e.after(r).css("width", "0px") : (e.before(r).css("width", "0px"), r.before(l)), e.animate({width: o + "px"}, a), l.animate({width: "0px"}, a, function () {
                    $(this).remove(), t = $(".task_tab .tab")
                })
            }
        }, v = function () {
            o = !1, s = !1, startTime = 0, $(".dragMaskView").remove(), void 0 != i && (l = e.get(0).getBoundingClientRect().left, i.animate({left: l + "px"}, a, function () {
                e.css("opacity", 1), $(this).remove()
            }))
        }
    }, s = function (e) {
        var t = 110, i = t, n = t + 12, s = $(".task_tab .tab"), o = $(".task_tab .tabs").width() - 10, r = s.length, l = Math.floor(o / n);
        switch (r > l && (i = Math.floor(o / r) - 12), e) {
            case"add":
                $(".task_tab .tabs .this").css("width", "0").animate({width: i + "px"}, a);
            case"close":
                s.animate({width: i + "px"}, a);
                break;
            case"resize":
                s.css("width", i + "px");
                break;
        ...
        $(n).insertBefore(".task_tab .last"), s("add"), e[t] = {id: t, name: name}
    }, r = function (e) {
    ...
    return {
        filetype: {
            ...
            var a, i, n = require("../tpl/search.html"), s = require("../tpl/search_list.html"), o = function () {
            ...
            var i = 0, n = 0, s = "0B/s", o = function (e, t) {
                var a = e.size * t, i = 5;
            ...
            uploader.on("uploadBeforeSend", function (e, t) {
                ...
                var a = o(e, t), r = $("#" + e.id), l = r.find(".progress .progress-bar");
    ...
    return {
        ...
        menuShow: function () {
            ...
            if (0 != e.length && 0 != t.length) {
                ...
                if (t.hasClass("dialog_menu")) {
                    var i = t.attr("id"), n = art.dialog.list[i];
        ...
        menuCurrentPath: function (e) {
            var t = ".createLink,.createProject,.cute,.remove,.rname,.zip,.unzip,.newfile,.newfolder,.newfileOther,.app_create,.app_install,.past,.upload,.clone", a = "disable";
    ...
    var s, o = function () {
        ...
        if (s) {
            var t = s.getSelectedNodes()[0], a = "", i = "";
    ...
    return {
        pathOpen: i, init: r, refresh: p, openEditor: function () {
            ...
            var i = d(), n = i.node, o = n.getParentNode(), r = "newfile", l = 0, c = LNG.newfolder;
            if ("folder" == e) {
    ...
    var a = ["/", "\\", ":", "*", "?", '"', "<", ">", "|"], i = function (e) {
        ...
        if (!(1 > e.length)) {
            var a = e[0].path, i = LNG.remove_title, s = a + "<br/><br/>" + LNG.remove_info, o = "vis.go?explorer/pathDelete";
        ...
        G.share_page !== void 0 && (a = "vis.go?share/pathInfo&user=" + G.user + "&sid=" + G.sid), $.ajax({
            ...
            success: function (a) {
                ...
                var s = template.compile(t[i]), o = UUID();
        ...
        var i = a.find("input.download_url"), s = i.get(0);
                ...
                name: LNG.button_save, focus: !0, callback: function () {
                    ...
                    switch (i) {
                        case"user_add":
                            ...
                            break;
                        case"user_edit":
                            s = "./vis.go?app/user_app&path=" + urlEncode2(t.path);
                            break;
                        case"root_add":
                            s = "./vis.go?app/add&name=" + e.name;
                            break;
                        case"root_edit":
                            s = "./vis.go?app/edit&name=" + e.name + "&old_name=" + t.name;
                            break;
                        default:
                    }
                    $.ajax({
    ...
    return {open: t, play: l, openEditor: o, openIE: n, download: i}
...
define("app/src/explorer/path", ["../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer"], function (e) {
    var t = e("../../common/pathOperate"), a = e("../../common/pathOpen"), n = void 0;
    ui.pathOpen = a;
    var s = function (e, t, a) {
        ...
        var a, i, n = 0, s = G.json_data.folderlist, o = G.json_data.filelist;
        ...
        if ("" != e) {
            if (e = e.toLowerCase(), void 0 == n || G.this_path != n.path || e != n.key) {
                ...
                }), n = {key: e, path: G.this_path, index: 0, list: t}
            }
        ...
        var a = "newfile", a = u(a, e), i = o(a, "file");
        i = 0 == i ? -1 : i - 1;
        var n = '<div class="file select menufile"  id="makefile">			<div class="' + e + ' ico"></div>				<div class="titleBox">					<span class="title">					<div class="textarea">						<textarea class="newfile fix">' + a + '</textarea>					</span>				</div>			</div>			<div style="clear:both;"></div>		</div>';
        ...
        var s = $(".newfile"), l = s.get(0), c = a.length - e.length - 1;
        if (Global.isIE) {
        ...
        fileLight.clear();
        var e = LNG.newfolder, e = u(e), a = o(e, "folder");
        a = 0 == a ? -1 : a - 1;
        ...
        var e = "", a = "", i = Global.fileListSelect, n = fileLight.name(i), s = fileLight.type(i);
        if (1 == i.length) {
        ...
        if (e) {
            ...
            return 0 == Global.fileListSelect.length ? t : (Global.fileListSelect.each(function () {
                ...
                "*share*/" == G.this_path && (e = $(this).attr("data-path"), a = "share"), t.push({path: e, type: a})
            }), t)
        }
        ...
        return "*share*/" == G.this_path && (i = a.attr("data-path"), n = "share"), {path: i, type: n}
    };
    return {
        appEdit: function (e) {
            if (e)t.appEdit(0, 0, "user_add"); else {
                var a = Global.fileListSelect.attr("data-app"), i = json_decode(urlDecode(a));
        ...
        open: function (e) {
            ...
            if (0 != b().path.length) {
                ...
                var t = b(), i = Global.fileListSelect;
        ...
        share_edit: function () {
            var e = b().path, a = G.json_data.share_list[e];
            t.share_box(a)
        },
        share_open_window: function () {
            var e = b().path, t = G.json_data.share_list[e], a = t.type;
            "folder" == t.type && (a = 1 == t.code_read ? "code_read" : "folder");
            var i = "./vis.go?share/" + a + "&user=" + G.user_name + "&sid=" + t.sid;
            window.open(i)
        },
        share_open_path: function () {
            var e = b().path, t = G.json_data.share_list[e], a = core.pathFather(t.path), i = core.pathThis(t.path);
        ...
        info: function () {
            if ("share" == b().type) {
                var e = b().path, a = G.json_data.share_list[e], i = a.path;
                t.info([{path: i, type: a.type}])
            } else t.info(b(!0))
        },
        past: function () {
