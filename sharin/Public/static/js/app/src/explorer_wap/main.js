define("app/src/explorer_wap/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "./ui", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "./path", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer"], function (e) {
    ...
    }, e("lib/jquery-lib"), e("lib/util"), e("lib/artDialog/jquery-artDialog"), ui = e("./ui"), core = e("../../common/core"), ui.path = e("./path"), $(document).ready(function () {
    ...
    var _ajaxLive = function () {
        $(".fileContiner .picture img").lazyload({container: $(".bodymain")})
    ...
    this._getFolderBoxList = function (e) {
        ...
        return a += "	<div class='folder ico' filetype='folder'></div>", a += "	<div id='" + e.name + "' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + t + "</span></div>", a += "	<div class='filesize'></div>", a += "	<div class='filetime'>" + e.mtime + "</div>", a += "	<div style='clear:both'></div>", a += "</div>"
        ...
        if ("number" == typeof e.exists && 0 == e.exists && (a = '<b style="color:red;">' + a + "</b>"), "oexe" == e.ext) {
            ...
            t = "<div class='file fileBox menufile' data-app=" + i + " onclick=''>", a = a.replace(".oexe", ""), "app_link" == e.type ? (t += 0 == e.content.search("ui.path.open") ? "<div class='" + core.pathExt(e.name.replace(".oexe", "")) + " ico'" : "<div class='folder ico'", t += ' filetype="oexe"></div><div class="app_link"></div>') : t += "<div class='oexe ico' filetype='oexe'></div>"
        } else if (inArray(core.filetype.image, e.ext)) {
            var n = core.path2url(G.this_path + e.name), o = "vis.go?explorer/image&path=" + urlEncode(G.this_path + e.name);
            t += "<div picasa='" + n + "' thumb='" + o + "' class='picasaImage file fileBox menufile' onclick=''>", t += "	<div class='" + e.ext + " ico' filetype='" + e.ext + "'></div>"
        } else t += "<div class='file fileBox menufile'  onclick=''>", t += "	<div class='" + e.ext + " ico' filetype='" + e.ext + "'></div>";
        return t += "	<div id='" + e.name + "' class='titleBox'><span class='title' title='" + LNG.double_click_rename + "'>" + a + "</span></div>", t += "	<div class='filesize'>" + e.size_friendly + "</div>", t += "	<div class='filetime'>" + e.mtime + "</div>", t += "	<div style='clear:both'></div>", t += "</div>"
    };
    var _mainSetData = function (e) {
        ...
        for (var n = "_getFileBoxList", o = "_getFolderBoxList", s = "", r = "", l = 0; i.length > l; l++)s += this[n](i[l]);
        for (var l = 0; a.length > l; l++)r += this[o](a[l]);
        t = "up" == G.sort_order ? r + s : s + r, "" == t && (t = '<div style="text-align:center;color:#aaa;">' + LNG.path_null + "</div>"), t += "<div style='clear:both'></div>", e ? $(Config.FileBoxSelector).hide().html(t).fadeIn(Config.AnimateTime) : $(Config.FileBoxSelector).html(t), $('<i class="file-action icon-font icon-ellipsis-horizontal"></i>').appendTo(Config.FileBoxClass), $(Config.FileBoxSelector + " .file:nth-child(2n)").addClass("file2"), _ajaxLive()
    }, _f5 = function (e, t) {
        void 0 == e && (e = !0), void 0 == t && (t = !1), _jsonSortTitle(), e ? $.ajax({
            ...
            success: function (e) {
                return $(".tools-left .msg").fadeOut(100), e.code ? (G.json_data = e.data, _f5_time_user(), Global.historyStatus = G.json_data.history_status, _mainSetData(t), ui.header.addressSet(), void 0) : (core.tips.tips(e), $(Config.FileBoxSelector).html(""), !1)
            },
            error: function (e, t, a) {
                $(".tools-left .msg").fadeOut(100), $(Config.FileBoxSelector).html(""), core.ajaxError(e, t, a)
            }
        }) : (fileLight.getAllName(), _mainSetData(t))
        ...
        var a = e.find(".titleBox").attr("id"), i = e.find(".ico").attr("filetype");
        switch (t) {
            case"action_copy":
                ui.path.copy(a, i);
                break;
        ...
        $(window).bind("hashchange", function () {
            var e = window.location.href, t = e.split("#");
            "" != t[1] && t[1] != G.this_path && ui.path.list(t[1])
        }), $(".fileContiner .file").die("click").live("click", function (e) {
            if ($(".fileContiner .file .file_action_menu").animate({left: "100%"}, 300, 0, function () {
                    $(this).remove()
                ...
                if ($(e.target).hasClass("file-action")) {
                    ...
                    return a.appendTo($(this)), a.removeClass("hidden").css({left: "100%"}).animate({left: "0%"}, 300, 0, function () {
                    }), void 0
                }
                var i = $(this).find(".ico").attr("filetype"), n = $(this).find(".titleBox").attr("id");
                ui.path.open(G.this_path + n, i), stopPP(e)
            }
        }), $(".address li").die("click").live("click", function (e) {
            var t = $(this).find("a").attr("title");
            ui.path.list(t), stopPP(e)
        })
    };
    return {
        f5: _f5, f5_callback: _f5_callback, init: function () {
            _f5_callback(function () {
                _f5(!1, !0)
            }), _fileActionBind(), ui.header.bindEvent()
        }, header: {
            bindEvent: function () {
                $(".right_tool").on("click", function () {
                    ...
                    switch (e) {
                        ...
                        case"public":
                            ...
                            break;
                        case"exit":
                            window.location.href = "./vis.go?user/logout";
                            break;
                        default:
                    }
                ...
                var e = G.this_path, t = function (e) {
                    var t = '<li class="item" onclick=""><a title="@1@" style="z-index:{$2};">{$3}</a><i>></i></li>\n';
                    e = e.replace(/\/+/g, "/");
                    var a = e.split("/");
                    "" == a[a.length - 1] && a.pop();
                    var i = a[0] + "/", n = t.replace(/@1@/g, i), o = a[0];
                    "" != a[0] ? "*share*" == o ? o = LNG.my_share : "*public*" == o ? o = LNG.public_path : "*recycle*" == o && (o = LNG.recycle) : o = LNG.root_path, n = n.replace("{$2}", a.length), n = n.replace("{$3}", o);
                    for (var s = n, r = 1, l = a.length - 1; a.length > r; r++, l--)i += a[r] + "/", n = t.replace(/@1@/g, i), n = n.replace("{$2}", l), n = n.replace("{$3}", a[r]), s += n;
                    return s
                };
    ...
    var n = function (e, t, a) {
        ...
        var t = "", a = 0;
        return null != G.json_data.filelist && (t = s(G.json_data.filelist, "name", e), null != t && (a = 1)), null != G.json_data.folderlist && (t = s(G.json_data.folderlist, "name", e), null != t && (a = 1)), a
    }, l = function (e, t) {
        var a, i = 0;
        if (void 0 == t) {
            if (!r(e))return e;
            for (a = e + "(0)"; r(a);)i++, a = e + "(" + i + ")";
            return a
        }
        if (!r(e + "." + t))return e + "." + t;
        for (a = e + "(0)." + t; r(a);)i++, a = e + "(" + i + ")." + t;
        return a
    }, c = function () {
        ...
        artDialog.prompt("", function (a) {
            var i = urlEncode(G.this_path + e), n = urlEncode(G.this_path + a);
            t.rname(i, n, function () {
                ui.f5()
            })
        }, e)
    }, p = function (e, t, a) {
        return "folder" != a && (a = "file"), e ? [{path: G.this_path + t, type: a}] : {path: G.this_path + t, type: a}
    };
    return {
        pathOperate: t, remove: function (e, a) {
        ...
        }, open: o, list: n, newFolder: c, rname: d
    }
