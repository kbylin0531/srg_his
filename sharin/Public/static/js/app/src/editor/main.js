define("app/src/editor/main", ["lib/jquery-lib", "lib/util", "lib/ztree/js/ztree", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "../../common/taskTap", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../common/rightMenu", "./ui", "../explorer/path", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer", "../../common/tree"], function (e) {
    Config = {
        TreeId: "folderList",
        AnimateTime: 200,
        pageApp: "editor",
        treeAjaxURL: "./vis.go?explorer/treeList&app=editor"
    }, Global = {
        topbar_height: 40,
        frameLeftWidth: 200,
        treeSpaceWide: 15,
        isIE: !-[1]
    }, e("lib/jquery-lib"), e("lib/util"), e("lib/ztree/js/ztree"), e("lib/contextMenu/jquery-contextMenu"), e("lib/artDialog/jquery-artDialog"), TaskTap = e("../../common/taskTap"), core = e("../../common/core"), rightMenu = e("../../common/rightMenu"), ui = e("./ui"), ui.path = e("../explorer/path"), tree = e("../../common/tree"), ui.tree = tree, $(document).ready(function () {
        $(".init_loading").fadeOut(450).addClass("pop_fadeout"), G.project.length > 1 && (Config.treeAjaxURL += "&project=" + urlEncode(G.project)), ui.init(), TaskTap.init(), core.update(), rightMenu.initEditor()
    })
...
}), define("app/src/editor/ui", [], function () {
    var e = function () {
        var e = !1, t = 0, a = 0, i = 0, n = $(".frame-left"), s = $(".frame-resize"), o = $(".frame-right");
        s.die("mousedown").live("mousedown", function (e) {
            return 1 != e.which ? !0 : (r(e), this.setCapture && this.setCapture(), $(document).mousemove(function (e) {
                l(e)
            }), $(document).one("mouseup", function (e) {
                return c(e), this.releaseCapture && this.releaseCapture(), stopPP(e), !1
            }), stopPP(e), !1)
        });
        var r = function (i) {
            e = !0, t = i.pageX, a = $(".frame-left").width(), s.addClass("active"), $(".resizeMask").css("display", "block")
        }, l = function (r) {
            if (!e)return !0;
            var l = r.pageX - t, c = a + l;
            i > c && (c = i), c > $(document).width() - 200 && (c = $(document).width() - 200), n.css("width", c), s.css("left", c - 5), o.css("left", c + 1)
        }, c = function () {
            return e ? (e = !1, s.removeClass("active"), Global.frameLeftWidth = $(".frame-left").width(), $(".resizeMask").css("display", "none"), void 0) : !1
        }
    }, t = function () {
        $(".tools-left a").click(function () {
    ...
    return {
        init: function () {
            e(), t(), tree.init(), $("html").die("click").live("click", function () {
                rightMenu.hidden(), Global.isIE && Global.isDragSelect
            }), Mousetrap.bind(["ctrl+s", "command+s"], function (e) {
                e.preventDefault(), e.returnvalue = !1, FrameCall.top("OpenopenEditor", "Editor.save", "")
            })
        }, setTheme: function (e) {
            core.setSkin(e, "app_editor.css"), FrameCall.top("OpenopenEditor", "Editor.setTheme", '"' + e + '"')
        }, editorFull: function () {
            var e = $("iframe[name=OpenopenEditor]");
            e.toggleClass("frame_fullscreen")
        }
