define("app/src/share_index/main", ["lib/jquery-lib", "lib/util", "lib/artDialog/jquery-artDialog", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../share_common/topbar", "./fileShow", "../edit/mode"], function (e) {
    Global = {
        topbar_height: 40,
        frameLeftWidth: 200,
        treeSpaceWide: 15,
        isIE: !-[1]
    }, e("lib/jquery-lib"), e("lib/util"), e("lib/artDialog/jquery-artDialog"), core = e("../../common/core"), topbar = e("../../share_common/topbar"), fileShow = e("./fileShow"), $(document).ready(function () {
        if ($(".init_loading").fadeOut(450).addClass("pop_fadeout"), "undefined" != typeof G) {
            fileShow.init(), core.update("check_status");
            var e = function () {
                var e = window.location.href + "&password=" + $(".form-control").val();
                $.get(e, function (e) {
                    1 == e.code ? window.location.reload() : core.tips.tips(e)
                })
            };
            $(".share_login").click(e), $(".form-control").keyEnter(e)
        }
    })
    ...
    return {init: a}
}), define("app/src/share_index/fileShow", ["../edit/mode"], function (e) {
    var t = "vis.go?share/fileDownload&user=" + G.user + "&sid=" + G.sid, a = "vis.go?share/fileProxy&user=" + G.user + "&sid=" + G.sid, i = function () {
        if (G.share_info !== void 0) {
            var e = core.pathExt(G.share_info.path);
            "file" != G.share_info.type && (a += "&path=" + G.path, t += "&path=" + G.path), "1" == G.share_info.not_download && (t = "javascript:core.tips.tips('" + LNG.share_not_download_tips + "',false);"), topbar.init(), r(e)
        } else $(".share_info").addClass("hidden")
    }, n = function () {
        var e = core.pathExt(G.share_info.path), a = $(".bindary_box");
        a.removeClass("hidden"), a.find(".name").html(G.share_info.name), a.find(".ico").addClass(e), a.find(".btn_download").attr("href", t);
        var i = date("Y/m/d h:i", G.share_info.mtime);
        a.find(".share_time").html(i), a.find(".size span").html(G.share_info.size)
    }, o = function (e) {
        for (var t = [], a = 0; e.length > a; a++)t[a] = e.charCodeAt(a).toString(16);
        return "&#" + String.fromCharCode(120) + t.join(";&#" + String.fromCharCode(120)) + ";"
    }, s = function () {
        var t = e("../edit/mode");
        $.get(a, function (e) {
            var a = core.pathExt(G.share_info.path), i = t.get(a);
            i || (i = "text");
            var n = '<pre class="code">' + o(e) + "</pre>";
            $(".content_box").addClass("show_code").append(n);
            var s = ace.require("ace/ext/static_highlight");
            ace.require("ace/lib/dom"), s($(".code").get(0), {
                mode: "ace/mode/" + i,
                wrapMode: !0,
        ...
        if (inArray(core.filetype.text, e) || inArray(core.filetype.code, e))return s(), void 0;
        if ("swf" == e) {
            var t = core.createFlash(a, "", "");
            return $(".content_box").addClass("show_swf").append(t), void 0
        }
        if ("pdf" == e) {
            if (Global.isIE)return n(), void 0;
            var t = '<a href="' + a + '" target="_blank" style="display:block;margin:0 auto;margin-top:80px;font-size:16px;text-align:center;">' + LNG.error + "   " + LNG.download + " PDF</a>";
            return $(".content_box").attr("id", "show_pdf").append(t), new PDFObject({url: a}).embed("show_pdf"), void 0
        }
        if (inArray(core.filetype.image, e)) {
            var t = '<img src="' + a + '"/>';
            return $(".content_box").addClass("show_image").append(t), void 0
        }
        if (inArray(core.filetype.music, e) || inArray(core.filetype.movie, e)) {
            var i = "skins/music/manila.zip", o = "music_player";
            inArray(core.filetype.movie, e) && (i = "skins/movie/webplayer.zip", o = "movie_player");
            var r = G.app_host + a + "#name_" + G.share_info.path, l = G.static_path + "js/lib/cmp4/cmp.swf", c = "url=&lists=&context_menu=2&auto_play=1&play_mode=1&name=kodExplorer&src=" + urlEncode(r) + "&skin=" + urlEncode(i) + "&label=" + G.share_info.path, t = core.createFlash(l, c, o);
            return $(".content_box").addClass(o).append(t), void 0
        }
        if (inArray(core.filetype.doc, e)) {
            var d = document.domain;
            if ("" == G.office_server) {
                if (0 == d.search("localhost") || 0 == d.search("192.168.") || 0 == d.search("127.0.0"))return n(), void 0;
                G.office_server = "https://view.officeapps.live.com/op/view.aspx?src="
            }
            a = G.office_server + urlEncode(G.app_host + a);
            var t = '<iframe src="' + a + '" frameborder="0" class="show_office"></iframe>';
            return $(".frame-main").addClass("office_page").append(t), $(".content_box").addClass("hidden"), void 0
        }
        n()
    };
    return {init: i}
