define("app/src/share_editor/main", ["lib/jquery-lib", "lib/util", "lib/ztree/js/ztree", "lib/contextMenu/jquery-contextMenu", "lib/artDialog/jquery-artDialog", "../../common/taskTap", "../../common/core", "../../tpl/copyright.html", "../../tpl/search.html", "../../tpl/search_list.html", "../../tpl/upload.html", "../../share_common/rightMenu", "./ui", "../../common/tree", "../../common/pathOperate", "../../tpl/fileinfo/file_info.html", "../../tpl/fileinfo/path_info.html", "../../tpl/fileinfo/path_info_more.html", "../../tpl/share.html", "../../tpl/app.html", "../../common/pathOpen", "../../common/CMPlayer", "../../share_common/topbar"], function (e) {
    Config = {
        ...
        AnimateTime: 200,
        pageApp: "editor",
        treeAjaxURL: "vis.go?share/treeList&app=editor&user=" + G.user + "&sid=" + G.sid
    }, Global = {
        topbar_height: 40,
        frameLeftWidth: 200,
        treeSpaceWide: 15,
        isIE: !-[1]
    }, e("lib/jquery-lib"), e("lib/util"), e("lib/ztree/js/ztree"), e("lib/contextMenu/jquery-contextMenu"), e("lib/artDialog/jquery-artDialog"), TaskTap = e("../../common/taskTap"), core = e("../../common/core"), rightMenu = e("../../share_common/rightMenu"), ui = e("./ui"), tree = e("../../common/tree"), ui.tree = tree;
    var t = e("../../share_common/topbar");
    $(document).ready(function () {
        $(".init_loading").fadeOut(450).addClass("pop_fadeout"), t.init(), G.project.length > 1 && (Config.treeAjaxURL += "&project=" + urlEncode(G.project)), ui.init(), TaskTap.init(), core.update("check_status"), rightMenu.initEditor()
    })
...
}), define("app/src/share_editor/ui", [], function () {
    var e = function () {
        var e = !1, t = 0, a = 0, i = 0, n = $(".frame-left"), o = $(".frame-resize"), s = $(".frame-right");
        ...
        var r = function (i) {
            e = !0, t = i.pageX, a = $(".frame-left").width(), o.addClass("active"), $(".resizeMask").css("display", "block")
        }, l = function (r) {
            if (!e)return !0;
            var l = r.pageX - t, c = a + l;
            i > c && (c = i), c > $(document).width() - 200 && (c = $(document).width() - 200), n.css("width", c), o.css("left", c - 5), s.css("left", c + 1)
        }, c = function () {
            return e ? (e = !1, o.removeClass("active"), Global.frameLeftWidth = $(".frame-left").width(), $(".resizeMask").css("display", "none"), void 0) : !1
        }
    }, t = function () {
