...
var ne = function(context){
    var instance = new (function () {return {ele: null};});
    if (context) {
...
// });
    return {
        ...
        table:function(){return this.ele},
        ...
        create: function (selector, opt) {
            ...
            if(ic.showCancel || ic.showConfirm){
                ...
                ic.showCancel &&  content.append(
                    $(ce("button.btn.btn-sm._cancel",{"type":"button","data-dismiss":"modal"},ic['cancelText'])).click(ic.cancel)
                );
