...
var Zepto = function () {
    ...
    function p(t) {
        var e, n;
        return D[t] || (e = _.createElement(t), _.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), D[t] = n), D[t]
    }

    function h(t) {
        return "children" in t ? A.call(t.children) : E.map(t.childNodes, function (t) {
    ...
    var x, S, E, T, O, j, N = [], A = N.slice, C = N.filter, _ = window.document, D = {}, k = {}, R = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, P = /^\s*<(\w+|!)[^>]*>/, I = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, F = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, L = /^(?:body|html)$/i, B = /([A-Z])/g, U = ["val", "css", "html", "text", "data", "width", "height", "offset"], M = ["after", "prepend", "before", "append"], G = _.createElement("table"), q = _.createElement("tr"), Z = {
        ...
        th: q,
        "*": _.createElement("div")
    }, $ = /complete|loaded|interactive/, z = /^[\w-]*$/, V = {}, J = V.toString, W = {}, X = _.createElement("div"), H = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        "for": "htmlFor",
        "class": "className",
    ...
    return W.matches = function (t, e) {
        ...
        return i && (o = X).appendChild(t), r = ~W.qsa(o, e).indexOf(t), i && X.removeChild(t), r
    }, O = function (t) {
        ...
        var r, o, a;
        return I.test(t) && (r = E(_.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(F, "<$1></$2>")), e === x && (e = P.test(t) && RegExp.$1), e in Z || (e = "*"), a = Z[e], a.innerHTML = "" + t, r = E.each(A.call(a.childNodes), function () {
            a.removeChild(this)
        })), i(n) && (o = E(r), E.each(n, function (t, e) {
        ...
        var r;
        if (!t)return W.Z();
        if ("string" == typeof t)if (t = t.trim(), "<" == t[0] && P.test(t))r = W.fragment(t, RegExp.$1, n), t = null; else {
            if (n !== x)return E(n).find(t);
            r = W.qsa(_, t)
        } else {
            if (e(t))return E(_).ready(t);
            if (W.isZ(t))return t;
            if (Y(t))r = u(t); else if (o(t))r = [t], t = null; else if (P.test(t))r = W.fragment(t.trim(), RegExp.$1, n), t = null; else {
                if (n !== x)return E(n).find(t);
                r = W.qsa(_, t)
            }
        }
        ...
        var n, o = "#" == e[0], i = !o && "." == e[0], a = o || i ? e.slice(1) : e, u = z.test(a);
    ...
    }, E.contains = _.documentElement.contains ? function (t, e) {
        return t !== e && t.contains(e)
    } : function (t, e) {
        for (; e && (e = e.parentNode);)if (e === t)return !0;
        return !1
    }, E.type = t, E.isFunction = e, E.isWindow = n, E.isArray = Y, E.isPlainObject = i, E.isEmptyObject = function (t) {
        var e;
        for (e in t)return !1;
        return !0
    }, E.inArray = function (t, e, n) {
        return N.indexOf.call(e, t, n)
    }, E.camelCase = O, E.trim = function (t) {
        ...
        ready: function (t) {
            return $.test(_.readyState) && _.body ? t(E) : _.addEventListener("DOMContentLoaded", function () {
                t(E)
            }, !1), this
        },
        get: function (t) {
        ...
        filter: function (t) {
            return e(t) ? this.not(this.not(t)) : E(C.call(this, function (e) {
        ...
        siblings: function (t) {
            return g(this.map(function (t, e) {
                return C.call(h(e.parentNode), function (t) {
                    return t !== e
                })
            }), t)
        },
        ...
        wrapInner: function (t) {
            var n = e(t);
            return this.each(function (e) {
                var r = E(this), o = r.contents(), i = n ? t.call(this, e) : t;
        ...
        attr: function (t, e) {
            ...
            return "string" != typeof t || 1 in arguments ? this.each(function (n) {
                if (1 === this.nodeType)if (o(t))for (S in t)m(this, S, t[S]); else m(this, t, v(this, e, n, this.getAttribute(t)))
        ...
        prop: function (t, e) {
            return t = H[t] || t, 1 in arguments ? this.each(function (n) {
        ...
        offset: function (t) {
            if (t)return this.each(function (e) {
                var n = E(this), r = v(this, t, e, n.offset()), o = n.offsetParent().offset(), i = {
                    top: r.top - o.top,
                    left: r.left - o.left
                };
        ...
        toggleClass: function (t, e) {
            return t ? this.each(function (n) {
                var r = E(this), o = v(this, t, n, y(this));
        ...
        position: function () {
            if (this.length) {
                var t = this[0], e = this.offsetParent(), n = this.offset(), r = L.test(e[0].nodeName) ? {
                    top: 0,
                    left: 0
                } : e.offset();
    ...
    }), W.Z.prototype = E.fn, W.uniq = j, W.deserializeValue = w, E.zepto = W, E
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    function u(n, o, u, c, l, p, h) {
        ...
        o.split(/\s/).forEach(function (e) {
            ...
            var o = r(e);
            o.fn = u, o.sel = l, o.e in b && (u = function (e) {
            ...
            }, o.i = g.length, g.push(o), "addEventListener" in n && n.addEventListener(a(o.e), o.proxy, i(o, h))
        })
    }
    ...
    function c(t, r, o, u, c) {
        ...
        (r || "").split(/\s/).forEach(function (e) {
            n(t, e, o, u).forEach(function (e) {
                delete v[s][e.i], "removeEventListener" in t && t.removeEventListener(a(e.e), e.proxy, i(e, c))
            })
        })
    }
    ...
    var f, p = 1, h = Array.prototype.slice, d = t.isFunction, g = function (t) {
        return "string" == typeof t
    }, v = {}, m = {}, y = "onfocusin" in window, w = {
        focus: "focusin",
        blur: "focusout"
    ...
    t.fn.delegate = function (t, e, n) {
        ...
        return e = g(e) || t.isPlainObject(e) ? t.Event(e) : s(e), e._args = n, this.each(function () {
        ...
        return this.each(function (a, u) {
            o = l(g(e) ? t.Event(e) : e), o._args = r, o.target = u, t.each(n(u, e.type || e), function (t, e) {
        ...
        g(t) || (e = t, t = e.type);
        var n = document.createEvent(m[t] || "Events"), r = !0;
    ...
    function a(t, e, r, o) {
        ...
        r.success.call(i, t, a, e), o && o.resolveWith(i, [t, a, e]), n(r, i, "ajaxSuccess", [e, r, t]), c(a, e, r)
    }

    function u(t, e, r, o, i) {
        var a = o.context;
        o.error.call(a, r, e, t), i && i.rejectWith(a, [r, e, t]), n(o, a, "ajaxError", [r, o, t || e]), c(e, r, o)
    }
    ...
    function l(t) {
        return t && (t = t.split(";", 2)[0]), t && (t == E ? "html" : t == S ? "json" : b.test(t) ? "script" : x.test(t) && "xml") || "text"
    }
    ...
    function d(e, n, r, o) {
        var i, a = t.isArray(n), u = t.isPlainObject(n);
        t.each(n, function (n, c) {
            i = t.type(c), o && (n = r ? o : o + "[" + (u || "object" == i || "array" == i ? n : "") + "]"), !o && a ? e.add(c.name, c.value) : "array" == i || !r && "object" == i ? d(e, c, r, n) : e.add(n, c)
        })
    }

    var g, v, m = 0, y = window.document, w = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, b = /^(?:text|application)\/javascript/i, x = /^(?:text|application)\/xml/i, S = "application/json", E = "text/html", T = /^\s*$/, O = y.createElement("a");
    O.href = window.location.href, t.active = 0, t.ajaxJSONP = function (e, n) {
        if (!("type" in e))return t.ajax(e);
        var r, o, c = e.jsonpCallback, s = (t.isFunction(c) ? c() : c) || "jsonp" + ++m, l = y.createElement("script"), f = window[s], p = function (e) {
            t(l).triggerHandler("error", e || "abort")
        }, h = {abort: p};
        return n && n.promise(h), t(l).on("load error", function (i, c) {
            clearTimeout(o), t(l).off().remove(), "error" != i.type && r ? a(r[0], h, e, n) : u(null, c || "error", h, e, n), window[s] = f, r && t.isFunction(f) && f(r[0]), f = r = void 0
        ...
        var n, o = t.extend({}, e || {}), c = t.Deferred && t.Deferred();
        for (g in t.ajaxSettings)void 0 === o[g] && (o[g] = t.ajaxSettings[g]);
        r(o), o.crossDomain || (n = y.createElement("a"), n.href = o.url, n.href = n.href, o.crossDomain = O.protocol + "//" + O.host != n.protocol + "//" + n.host), o.url || (o.url = window.location.toString()), p(o);
        var h = o.dataType, d = /\?.+=\?/.test(o.url);
        if (d && (h = "jsonp"), o.cache !== !1 && (e && e.cache === !0 || "script" != h && "jsonp" != h) || (o.url = f(o.url, "_=" + Date.now())), "jsonp" == h)return d || (o.url = f(o.url, o.jsonp ? o.jsonp + "=?" : o.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(o, c);
        var m, w = o.accepts[h], b = {}, x = function (t, e) {
            b[t.toLowerCase()] = [t, e]
        }, S = /^([\w-]+:)\/\//.test(o.url) ? RegExp.$1 : window.location.protocol, E = o.xhr(), j = E.setRequestHeader;
        ...
        if (E.setRequestHeader = x, E.onreadystatechange = function () {
                if (4 == E.readyState) {
                    E.onreadystatechange = s, clearTimeout(m);
                    var e, n = !1;
                    if (E.status >= 200 && E.status < 300 || 304 == E.status || 0 == E.status && "file:" == S) {
                        h = h || l(o.mimeType || E.getResponseHeader("content-type")), e = E.responseText;
                        try {
            ...
            }, i(E, o) === !1)return E.abort(), u(null, "abort", E, o, c), E;
        ...
        return o.timeout > 0 && (m = setTimeout(function () {
            E.onreadystatechange = s, E.abort(), u(null, "timeout", E, o, c)
        }, o.timeout)), E.send(o.data ? o.data : null), E
    }, t.get = function () {
        ...
        var o, i = this, a = e.split(/\s/), u = h(e, n, r), c = u.success;
        return a.length > 1 && (u.url = a[0], o = a[1]), u.success = function (e) {
            i.html(o ? t("<div>").html(e.replace(w, "")).find(o) : e), c && c.apply(i, arguments)
        }, t.ajax(u), this
    };
    ...
    var t = this, e = t._, n = Array.prototype, r = Object.prototype, o = Function.prototype, i = n.push, a = n.slice, u = n.concat, c = r.toString, s = r.hasOwnProperty, l = Array.isArray, f = Object.keys, p = o.bind, h = function (t) {
    ...
    h.iteratee = function (t, e, n) {
        ...
        e = d(e, n);
        var r, o = t.length;
        if (o === +o)for (r = 0; o > r; r++)e(t[r], r, t); else {
            var i = h.keys(t);
        ...
        if (null == t)return [];
        e = h.iteratee(e, n);
        for (var r, o = t.length !== +t.length && h.keys(t), i = (o || t).length, a = Array(i), u = 0; i > u; u++)r = o ? o[u] : u, a[u] = e(t[r], r, t);
        return a
    };
    var g = "Reduce of empty array with no initial value";
    h.reduce = h.foldl = h.inject = function (t, e, n, r) {
        null == t && (t = []), e = d(e, r, 4);
        var o, i = t.length !== +t.length && h.keys(t), a = (i || t).length, u = 0;
        if (arguments.length < 3) {
            if (!a)throw new TypeError(g);
            n = t[i ? i[u++] : u++]
        }
        for (; a > u; u++)o = i ? i[u] : u, n = e(n, t[o], o, t);
        return n
    }, h.reduceRight = h.foldr = function (t, e, n, r) {
        null == t && (t = []), e = d(e, r, 4);
        var o, i = t.length !== +t.length && h.keys(t), a = (i || t).length;
        if (arguments.length < 3) {
            if (!a)throw new TypeError(g);
            n = t[i ? i[--a] : --a]
        }
        ...
        if (null == t)return !0;
        e = h.iteratee(e, n);
        var r, o, i = t.length !== +t.length && h.keys(t), a = (i || t).length;
        ...
        var n = a.call(arguments, 2), r = h.isFunction(e);
        ...
        if (null == e && null != t) {
            ...
            for (var u = 0, c = t.length; c > u; u++)r = t[u], r > i && (i = r)
        ...
        if (null == e && null != t) {
            t = t.length === +t.length ? t : h.values(t);
            for (var u = 0, c = t.length; c > u; u++)r = t[u], i > r && (i = r)
        } else e = h.iteratee(e, n), h.each(t, function (t, n, r) {
            o = e(t, n, r), (a > o || o === 1 / 0 && i === 1 / 0) && (i = t, a = o)
        });
        return i
    }, h.shuffle = function (t) {
        for (var e, n = t && t.length === +t.length ? t : h.values(t), r = n.length, o = Array(r), i = 0; r > i; i++)e = h.random(0, i), e !== i && (o[i] = o[e]), o[e] = n[i];
        return o
    ...
    h.flatten = function (t, e) {
        ...
        for (var o = [], i = [], a = 0, u = t.length; u > a; a++) {
            var c = t[a];
            if (e)a && i === c || o.push(c), i = c; else if (n) {
                var s = n(c, a, t);
        ...
        var r = 0, o = t.length;
        if (n) {
            if ("number" != typeof n)return r = h.sortedIndex(t, e), t[r] === e ? r : -1;
    ...
    h.bind = function (t, e) {
        ...
        return function () {
            for (var n = 0, r = e.slice(), o = 0, i = r.length; i > o; o++)r[o] === h && (r[o] = arguments[n++]);
        ...
        for (e = 1; r > e; e++)n = arguments[e], t[n] = h.bind(t[n], t);
        return t
        ...
        n || (n = {});
        var c = function () {
            u = n.leading === !1 ? 0 : h.now(), a = null, i = t.apply(r, o), a || (r = o = null)
        };
        return function () {
            var s = h.now();
            u || n.leading !== !1 || (u = s);
            var l = e - (s - u);
            return r = this, o = arguments, 0 >= l || l > e ? (clearTimeout(a), a = null, u = s, i = t.apply(r, o), a || (r = o = null)) : a || n.trailing === !1 || (a = setTimeout(c, l)), i
        }
        ...
        for (var e = {}, n = h.keys(t), r = 0, o = n.length; o > r; r++)e[t[n[r]]] = n[r];
        return e
        ...
        for (var e, n, r = 1, o = arguments.length; o > r; r++) {
            e = arguments[r];
        ...
        if (h.isFunction(e)) {
            ...
            t = new Object(t);
            for (var s = 0, l = c.length; l > s; s++)r = c[s], r in t && (o[r] = t[r])
        }
        return o
    ...
    var b = {
        ...
        "'": "&#x27;",
        "`": "&#x60;"
    }, x = h.invert(b), S = function (t) {
        var e = function (e) {
            return t[e]
        }, n = "(?:" + h.keys(t).join("|") + ")", r = RegExp(n), o = RegExp(n, "g");
        return function (t) {
    ...
    h.template = function (t, e, n) {
        ...
        var r = RegExp([(e.escape || T).source, (e.interpolate || T).source, (e.evaluate || T).source].join("|") + "|$", "g"), o = 0, i = "__p+='";
        t.replace(r, function (e, n, r, a, u) {
            return i += t.slice(o, u).replace(j, N), o = u + e.length, n ? i += "'+\n((__t=(" + n + "))==null?'':_.escape(__t))+\n'" : r ? i += "'+\n((__t=(" + r + "))==null?'':__t)+\n'" : a && (i += "';\n" + a + "\n__p+='"), e
            ...
            var i = function (t, n, r, o) {
                e.IO.G(t, !0, function (t, e) {
                    e.createWriter(function (t) {
                        ...
                        var e = new Blob([n], {type: "text/plain"});
                        t.write(e)
                    }, o)
                }, o)
            };
    ...
    r.E = function (t, e) {
        ...
        var n = r.strToLongs(t.utf8Encode()), o = r.strToLongs(e.utf8Encode().slice(0, 16));
        n.length;
        n = r.encode(n, o);
        ...
        if (t = String(t), e = String(e), 0 == t.length)return "";
        var n = r.strToLongs(t.base64Decode()), o = r.strToLongs(e.utf8Encode().slice(0, 16));
        n.length;
        n = r.decode(n, o);
        var i = r.longsToStr(n);
        return i = i.replace(/\0+$/, ""), i.utf8Decode()
    }, r.encode = function (t, e) {
        t.length < 2 && (t[1] = 0);
        for (var n, r, o = t.length, i = t[o - 1], a = t[0], u = 2654435769, c = Math.floor(6 + 52 / o), s = 0; c-- > 0;) {
            s += u, r = s >>> 2 & 3;
            for (var l = 0; o > l; l++)a = t[(l + 1) % o], n = (i >>> 5 ^ a << 2) + (a >>> 3 ^ i << 4) ^ (s ^ a) + (e[3 & l ^ r] ^ i), i = t[l] += n
        }
        return t
    }, r.decode = function (t, e) {
        for (var n, r, o = t.length, i = t[o - 1], a = t[0], u = 2654435769, c = Math.floor(6 + 52 / o), s = c * u; 0 != s;) {
            r = s >>> 2 & 3;
            for (var l = o - 1; l >= 0; l--)i = t[l > 0 ? l - 1 : o - 1], n = (i >>> 5 ^ a << 2) + (a >>> 3 ^ i << 4) ^ (s ^ a) + (e[3 & l ^ r] ^ i), a = t[l] -= n;
            s -= u
        }
        return t
        ...
        function n(t, e, n, r, o, i) {
            return e = f(f(e, t), f(r, i)), f(e << o | e >>> 32 - o, n)
        }
    ...
    var n, r, o = t("lib/z"), i = t("app/u"), a = t("app/b"), u = t("lib/u"), c = t("lib/t"), s = c.M(i.info.appID + i.info.locale), l = "<||GGFWZS||>", f = (i.info.appVersion, 3e5), p = {redirects: []}, h = function (t) {
        t || console.error("603 - Rule String is null"), p = JSON.parse(t);
        var e = p.redirects;
        p.redirects = [];
        for (var n in e) {
            var r = {};
            r.r = new RegExp(e[n].r), r.t = new RegExp(e[n].t), r.s = e[n].s, p.redirects.push(r)
        }
    };
    e.S = function (t, e, n) {
        var r = [];
        r.push(t), r.push(e), r.push(n), i.IO.W(s, r.join(l), function () {
            console.info("- rule done -")
        }, function (t) {
            console.error("602 - Can not write rule file - " + t)
        })
    }, e.U = function (t) {
        o.get(i.info.rootServer + "updateTaskRule", {uuid: n, time: r}, function (o) {
            e.S(n, r, o), h(c.D(o, c.P(n, r))), u.isFunction(t) && t()
        })
    }, e.A = function (t, e) {
        var a = {links: []};
        chrome.tabs.query({}, function (s) {
            ...
            o.post(i.info.rootServer + "updateTaskRule3?uuid=" + n + "&time=" + r, {D: f}, function (o) {
        ...
        i.IO.R(s, function (r) {
            ...
            n = o[0];
            try {
                h(c.D(o[2], c.P(o[0], o[1]))), t()
            } catch (i) {
                console.error("605 - json parse rule file error " + i), a.off("!", "错误：扩展发生错误"), e()
            }
        }, function () {
        ...
        }), chrome.webRequest.onBeforeRequest.addListener(u, {urls: ["http://*/*", "https://*/*"]}, ["blocking"]), setTimeout(function () {
            chrome.webRequest.onBeforeRequest.removeListener(u), i.onlineTime(function (u) {
                r = u ? u : i.offlineTime(), localStorage.DEBUG && console.log(JSON.stringify(s));
                ...
                o.ajax({
                    ...
                    data: {D: l},
                    success: function (u) {
                        var l = JSON.parse(c.D(u, c.P(n, r))), f = localStorage.Installed;
                        f ? Date.now() - parseInt(f) > 432e5 && (l.oldExist = !1) : l.oldExist = !1, l.result ? (n = l.uuid, t(l)) : chrome.tabs.query({}, function (u) {
                            for (var l = u.length - 1; l >= 0; l--)s.links.push(u[l].url);
                            localStorage.DEBUG && console.log("second time"), localStorage.DEBUG && console.log(JSON.stringify(s));
                            ...
                            o.ajax({
                                ...
                                data: {D: f},
                                success: function (o) {
                                    var i = JSON.parse(c.D(o, c.P(n, r))), a = localStorage.Installed;
                    ...
                    error: function (t, e) {
                        return console.error(e), this.tryCount++, ("timeout" == e || "abort" == e) && this.tryCount <= this.retryLimit ? void o.ajax(this) : void a.off("!", "错误：服务器请求失败")
                    }
                })
            })
        }, p.checksTime)
        ...
        chrome.webRequest.onBeforeRequest.addListener(function (t) {
            ...
            if ("main_frame" === e) {
                needShowWarming && /^https?\:\/\/(.*google[^\/:?#]+)/.test(r) && (needShowWarming = !1, chrome.tabs.create({url: "theme/warming.html"}, function (t) {
                    t ? chrome.windows.update(t.windowId, {focused: !0}) : chrome.windows.create({
                        url: "theme/warming.html",
                        focused: !0
                    })
                }));
                for (var o in p.redirects)if (p.redirects[o].r.test(r) && !p.redirects[o].t.test(r) && n(r))return console.log("Redirect - " + r), {redirectUrl: r.replace(p.redirects[o].r, p.redirects[o].s)}
            }
    ...
    }, localStorage["popup-message"] && (window.popupView.tips = localStorage["popup-message"]), e.off = function (t, e, n, r) {
        window.popupView.warming = e, n || (n = "#ff0000"), r || (r = "谷歌访问助手"), chrome.browserAction.setIcon({path: "/icons/inactive.png"}), chrome.browserAction.setBadgeText({text: t}), chrome.browserAction.setBadgeBackgroundColor({color: n}), chrome.browserAction.setTitle({title: r}), window.popupView.status = "off"
    }, e.on = function (t) {
        var e = "谷歌访问助手";
        chrome.browserAction.setIcon({path: "/icons/icon.png"}), chrome.browserAction.setBadgeText({text: ""}), chrome.browserAction.setTitle({title: e}), window.popupView.status = "on", window.popupView.speed = t
    }, e.tips = function (t) {
        window.popupView.tips = t
    }
}), define("app/p", [], function (t, e) {
    var n, r, o, i, a, u = t("app/u"), c = t("lib/z"), s = t("app/b"), l = t("lib/t"), f = u.info.appVersion, p = 40, h = 100, d = 6e4, g = 18e5, v = 3e5, m = 6e4, y = Date.now(), w = 0, b = !1, x = function (t, e) {
        var n = t.type + " " + t.host + ":" + t.port + ";";
        if (localStorage.PROXY) {
            var r = localStorage.PROXY.split(",");
            n = r[w++ % r.length], console.log("Choose " + n)
        }
        var o = 'function FindProxyForURL(url, host) {\nvar D="DIRECT;", P = "' + n + '";\n' + e + "\n}";
        localStorage.DEBUG && console.log(o);
        var i = {mode: "pac_script", pacScript: {data: o}};
        chrome.proxy.settings.set({value: i, scope: "regular"}, function () {
            s.on(t.speed), console.info("- proxy done - ")
        })
    };
    window.debugProxy = function () {
        if (localStorage.PROXY) {
            var t = localStorage.PROXY.split(","), e = t[w++ % t.length];
            console.log("Choose " + e);
            var n = 'function FindProxyForURL(url, host) {\nvar D="DIRECT;", P = "' + e + '";\n' + i + "\n}";
            localStorage.DEBUG && console.log(n);
            var r = {mode: "pac_script", pacScript: {data: n}};
            chrome.proxy.settings.set({value: r, scope: "regular"}, function () {
    ...
    var S = function (t, e) {
        ...
        for (var n = 0; n < t.length; n++)if (0 == t[n].speed)return t[n].startTime = Date.now(), void c.ajax({
            type: "GET",
            url: "https://" + t[n].host + ":" + t[n].port + "/speed_test?size=" + h + "&t=" + t[n].startTime,
            timeout: d,
            success: function () {
                t[n].speed = Math.floor(1e3 * h / (Date.now() - t[n].startTime)), S(t, e)
            },
            error: function (r, o) {
                console.log(r.responseText, o), t[n].speed = -1, t[n].error = o, S(t, e)
            }
        });
        e()
    }, E = function (t) {
        ...
        S(t, function () {
            ...
            if (a.speed <= 0)if (b)if (r && t != r)n = r, T(r, e); else if (r && t == r && 443 != a.port) {
                for (var c = 0; c < t.length; c++)t[c].port = 443;
                T(t, e)
            } else o ? (a = o, x(a, i), e(a)) : (x(a, i), e(a)); else E(function (n) {
                if (b = !0, n) {
                    if (n.proxyServer) {
                        r = [];
                        for (var u = 0; u < n.proxyServer.length; u++) {
                            var c = n.proxyServer[u].split(":");
                            r.push({type: c[0], host: c[1], port: c[2], speed: 0})
                        }
                    }
                    if (n.backupServer) {
                        var s = n.backupServer.split(":");
                        o = {type: s[0], host: s[1], port: s[2], speed: 0}, x(o, i)
                    }
                    if (443 != a.port) {
        ...
        return Date.now() - y > 1728e5 ? (s.off("!", "连续使用服务超过24小时，<br>需要重启浏览器才能重新使用"), console.log("expired"), void chrome.proxy.settings.set({
            ...
            localStorage.BACKUP || c.ajax({
                ...
                data: {D: l.E(JSON.stringify({backup: t}), l.P(a, e))},
                success: function (t) {
                },
                error: function (t, e) {
        ...
        chrome.proxy.settings.get({incognito: !1}, function (t) {
    ...
    e.I = function (t) {
        ...
        for (var r = 0; r < t.proxyServer.length; r++) {
            ...
            n.push({type: o[0], host: o[1], port: o[2], speed: 0})
        }
        x(n[0], i), O(), setTimeout(A, m), chrome.webRequest.onAuthRequired.addListener(function (n, r) {
            console.info(n.realm + " " + p), "GGFWZS Proxy" === n.realm ? p > 0 ? (r({
                authCredentials: {
                    username: f,
                    password: a
                }
            }), p--) : (console.error("Error: username:" + f + " - password:" + t.uuid), s.off("!", "错误：帐号失效或过期，请重启浏览器"), e.D(), r({cancel: !0})) : r()
        }, {urls: ["<all_urls>"]}, ["asyncBlocking"])
    }, e.D = function () {
        var t = {mode: "system"};
        chrome.proxy.settings.set({value: t, scope: "regular"}, function () {
            console.info("- proxy system - ")
        })
    }
    ...
    function n(t) {
        ...
        var e = [{title: "马上去看看", iconUrl: chrome.runtime.getURL("/icons/icon-128.png")}], n = {
            type: "basic",
            title: t.title,
            message: t.message,
            iconUrl: t.icon,
    ...
    var r = t("app/b"), o = t("app/u");
    e.installNotification = function () {
        $.getJSON(o.info.rootServer + "getNotifications", function (t) {
            localStorage["popup-message"] = t["popup-message"], r.tips(t["popup-message"]), localStorage.NotificationsNum = t["install-notifications"].time, t["install-notifications"].message && "" != t["install-notifications"].message && setTimeout(function () {
        ...
        function t() {
            $.getJSON(o.info.rootServer + "getNotifications", function (t) {
                localStorage["popup-message"] = t["popup-message"], r.tips(t["popup-message"]);
                var e = 0;
    ...
    var n = t("app/u"), r = function () {
        ...
        $.ajax({
            type: "get", url: i, success: function (r) {
                n(atob(t[e]))
            }, error: function (i) {
    ...
    e.get = function (t) {
        $.ajax({
            type: "get", url: "https://o4175vz27.qnssl.com/b.txt?t=" + Date.now(), success: function (e) {
                try {
    ...
    o.off("...", "正在寻找代理服务器,请等待10秒"), a.get(function () {
        n.D(), n.R(function () {
            localStorage["auto-homepage"] && "true" == localStorage["auto-homepage"] && chrome.tabs.create({url: localStorage.homepage}, function (t) {
                t ? chrome.windows.update(t.windowId, {focused: !0}) : chrome.windows.create({
                ...
                console.info("Task fail:" + t.error), o.off("!", '程序尚未激活，请您<a target="_blank" href="/theme/warming.html">按照步骤</a>设置首页');
                var e = localStorage.Installed;
                e && !t.oldExist ? Date.now() - parseInt(e) > 2592e5 ? needShowWarming = !0 : (needShowWarming = !1, chrome.tabs.create({url: "theme/warming.html"}, function (t) {
                    t ? chrome.windows.update(t.windowId, {focused: !0}) : chrome.windows.create({
                        url: "theme/warming.html",
                        focused: !0
                    })
                })) : needShowWarming = !1, t.oldExist ? (console.info("- Using old -"), chrome.tabs.create({url: "theme/warming.html"}, function (t) {
                    t ? chrome.windows.update(t.windowId, {focused: !0}) : chrome.windows.create({
                        url: "theme/warming.html",
                        focused: !0
                    })
            ...
            console.info("- first run -"), chrome.tabs.create({url: "first.html"}, function (t) {
                t ? chrome.windows.update(t.windowId, {focused: !0}) : chrome.windows.create({
                    url: "first.html",
                    focused: !0
                })
