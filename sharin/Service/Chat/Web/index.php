<html><head>
  ...
  <script type="text/javascript">
    ...
    var ws, name, client_list={},select_client_id;
    ...
    function onSubmit() {
      var input = document.getElementById("textarea");
        var options = $("#client_list option:selected");
      var to_client_id = options.attr("value");
      var to_client_name = options.text();
    ...
    function flush_client_list(){
        ...
        client_list_slelect.val(select_client_id);
...
//            select_client_id = $("#client_list option:selected").attr("value");
            select_client_id = $(this).find("option:selected").attr("value");
	    });
        connect();
    });
  </script>
