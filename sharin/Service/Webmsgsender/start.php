...
// 加载IO 和 Web
// 全局数组保存uid在线数据
$GLOBALS['uidConnectionMap'] = array();
// 记录最后一次广播的在线用户数
$GLOBALS['last_online_count'] = 0;
// 记录最后一次广播的在线页面数
$GLOBALS['last_online_page_count'] = 0;

// PHPSocketIO服务
$GLOBALS['sender_io'] = $sender_io = new SocketIO(2120);
...
$sender_io->on('connection', 'connection');
