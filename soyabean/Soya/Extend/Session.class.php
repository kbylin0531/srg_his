...
class Session extends \Soya{
     ...
     * @return string
     */
    public function getEncodedSessionData(){
...
//        $_SESSION =  array();
     ...
     * @return string
     */
    public function id($id=null,$regenerate=false){
     ...
     * @return bool
     */
    public function setSaveHandler(\SessionHandlerInterface $session_handler, $register_shutdown= true){
