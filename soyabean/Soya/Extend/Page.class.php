...
class Page extends \Soya{
    ...
    public function show($class='',$styled=false) {
        ...
        $this->url = URI::url(REQUEST_ACTION, $this->parameter);
        /* 计算分页零时变量 */
