...
var Layout = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            var available_height = App.getViewPort().height - page_footer.outerHeight() - page_header.outerHeight();
    ...
    var handleSidebarMenu = function () {
        ...
        page_sidebar_menu.on('click', 'li > a.nav-toggle, li > a > span.nav-toggle', function (e) {
            ...
            if (App.getViewPort().width >= resBreakpointMd && !page_sidebar_menu.attr("data-initialized") && thisbody.hasClass('page-sidebar-closed') &&  that.parent('li').parent('.page-sidebar-menu').size() === 1) {
                return;
            }
        ...
        if (App.isAngularJsApp()) {
            page_sidebar_menu.find("li > a").on("click", function() {
    ...
    var _calculateFixedSidebarViewportHeight = function () {
        var sidebarHeight = App.getViewPort().height - page_header.outerHeight(true);
    ...
    var handleHorizontalMenu = function () {
        //handle tab click
        page_header.on('click', '.hor-menu a[data-toggle="tab"]', function (e) {
            e.preventDefault();
        ...
        page_header.on('click', '.search-form', function () {
            ...
            form_controll.on('blur', function () {
